      ...
      <div style={{ ...containerStyle, fontFamily: "var(--font-poppins)" }}>
        ...
        <div style={twoColumnSection}>
          ...
          <div style={leftColumn}>
            <p style={paragraphStyle}>
              ...
              improvement, develop tools, identify problem areas, measure
              performance, validate changes and create models of current and
              future processes and help maximize efficiency and productivity. In
            ...
            <p style={paragraphStyle}>
              ...
              standard operating procedures, to process synchronization and
              quality management, it’s important that the people involved in
              improving your company’s processes are given the right knowledge,
              tools, and techniques to successfully implement a systematic
              approach. In developing a team attitude toward improving quality
        ...
        <div style={highlightSection}>
          ...
          >
            ...
            >
              Our vast portfolio of experience includes every modality available
              for technical learners: instructor-led both in the classroom and
              virtual environment; self-paced eLearning, podcasts, videos,
              mobile learning solutions, game-based learning, and social
              learning.
              <br />
              <br />
              When new modalities are introduced, the team at Tetrahedron makes
              sure it learns and masters those platforms and training
              strategies. <br />
              <br />
              Ours is a consultative approach.
              <br />
              <br />
              Even when a client asks for a proposal on a specific modality,
              Tetrahedron does its due diligence to make sure the preferred
              approach can achieve the client’s learning objectives within their
              budget and timeframe.
              <br />
              <br />
              In the event, our needs assessment finds an alternative or blended
              approach that would provide stronger results we are not afraid to
              say so. In fact, we believe it’s our obligation to do so.
            </p>
          </div>
          ...
          >
            ...
            >
              Request to know more about the Process Improvement Training
              Program Courses
            </p>
          </div>
        </div>
        ...
        {/* Signature Programs */}
        <div
          style={{ ...paragraphContainer, marginTop: 0, textAlign: "center" }}
        >
          <h2
            style={{
              ...highlightHeading,
...
const leftColumn = { flex: "1 1 60%", minWidth: "300px" };
const rightColumn = {
  flex: "1 1 35%",
  minWidth: "280px",
  display: "flex",
...
const highlightText = { fontSize: "1rem", lineHeight: "1.6", color: "#666" };
