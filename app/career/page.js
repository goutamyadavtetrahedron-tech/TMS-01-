...
export default function CareerPage() {
  ...
  const internshipData = [
    {
      title: "Training Content Development Intern",
      type: "Work from Home",
      duration: "6 Months",
      stipend: "As per the interview",
      positions: "3–4",
      description: "Develop, structure, and create high-quality training content, learning materials, and course modules."
    },
    {
      title: "Digital Marketing Intern",
      type: "Work from Home / On-site",
      duration: "6 Months",
      stipend: "As per the interview",
      positions: "1",
      description: "Assist with SEO, performance marketing campaigns, and social media management."
    },
    {
      ...
      stipend: "As per the interview",
      positions: "1",
      description: "Create compelling visual concepts, assist with marketing materials, and support brand design initiatives."
    },
    {
      title: "ROS Engineer (Robotics)",
      type: "On-site / Hybrid",
      duration: "6 Months",
      stipend: "As per the interview",
      positions: "1",
      description: "Build and optimize ROS-based control systems for robotic automation."
    }
  ];
                ...
                >
                  ...
                  <div style={{ padding: "24px", display: 'flex', flexDirection: 'column', alignItems: 'flex-start', flex: 1, width: '100%', boxSizing: 'border-box' }}>
                    ...
                    <span style={{
                      ...
                      {item.type ? `Internship (${item.type})` : (selectedOption === "job" ? "Full Time" : "Internship")}
                    </span>
                    ...
                    {(item.type || item.duration || item.stipend || item.positions) && (
                      <div style={{
                        width: '100%',
                        background: '#f8f9fa',
                        borderRadius: '10px',
                        ...
                        {item.type && (
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <span style={{ fontWeight: 600, color: '#1a1a2e' }}>{item.type}</span>
                          </div>
                        )}
                        {item.duration && (
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ color: '#666', fontWeight: 500 }}>Duration:</span>
                            <span style={{ fontWeight: 600, color: '#1a1a2e' }}>{item.duration}</span>
                          </div>
                        )}
                        {item.stipend && (
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ color: '#666', fontWeight: 500 }}>Stipend:</span>
                            <span style={{ fontWeight: 600, color: '#1a1a2e' }}>{item.stipend}</span>
                          </div>
                        )}
                        {item.positions && (
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ color: '#666', fontWeight: 500 }}>Positions:</span>
                            <span style={{ fontWeight: 600, color: '#1a1a2e' }}>{item.positions}</span>
                          </div>
                        )}
                      </div>
                    )}
