...
export const consultingPages = {
  "tpm-consultants": {
    ...
    heroLayout: "split", // Enable split layout with form
    heroBackgroundImage: "/images/servicesData/5.jpeg?id=28655",
    heroTitle: "TPM CONSULTANTS | TOTAL PRODUCTIVE MAINTENANCE CONSULTING",
    heroSubtitle: "Achieve Higher Quality, Fewer Defects & Lower Manufacturing Cost with us.",
    heroFeaturesList: [
    ...
    whyChoose: {
      title:
        "WHY COMPANIES CHOOSE THE TPM APPROACH: INSIGHTS FROM TPM CONSULTANTS",
      content:
    ...
    features: [
      // Array of objects {icon, title, desc}
      {
        icon: "Briefcase",
        title: "Productivity",
    ...
    certification: {
      // Object {title, content, process[], note}
    ...
    caseStudy: {
      // Object {title, content} - Describes the case study context
      title:
    ...
    outcomes: {
      // Object {challenges[], approach[], results[]} - Details the case study specifics
      challenges: [
        "Max. OEE was 45%",
      ...
      items: [
        {
          ...
          answer:
            "Overall Equipment Effectiveness (OEE) is a key TPM metric measuring manufacturing productivity. It combines availability, performance, and quality.",
        },
        {
          question: "What are the major losses TPM addresses?",
          answer:
            "TPM targets losses like equipment breakdowns, setup/adjustment time, idling/minor stoppages, reduced speed, defects/rework, and startup losses.",
        },
  ...
  "tqm-consultants": {
    ...
    heroLayout: "split",
    heroBackgroundImage: "/images/servicesData/Banner-Image_-A-Path-to-Excellence-TQM_-1.jpg?id=29955",
    heroTitle: "TQM CONSULTANTS | TOTAL QUALITY MANAGEMENT CONSULTING",
    heroSubtitle: "Customer Satisfaction | Standardization | Continuous Improvement",
    heroFeaturesList: [
      "Worldwide companies are always seeking continuous improvement in their processes, increasing the quality of their products and services. Our TQM consultants ensure your company operates at peak performance through improved workflows and enhanced quality."
    ],
    bannerTitle: "TQM CONSULTANTS | TOTAL QUALITY MANAGEMENT CONSULTING",
    bannerSubtitle:
      "Customer Satisfaction | Standardization | Continuous Improvement",
    bannerDescription:
      "Worldwide companies are always seeking continuous improvement in their processes, increasing the quality of their products and services. Our TQM consultants ensure your company operates at peak performance through improved workflows and enhanced quality.",
    introText:
      "Total Quality Management (TQM) is a management strategy focused on long-term success through customer satisfaction and continuous improvement. Our consultants help implement TQM to eliminate faults, optimize costs, and align all departments with quality objectives.",
    whyChoose: {
      title: "WHY IMPLEMENT TQM IN MANUFACTURING INDUSTRY?",
      content:
        "TQM reduces variability in production, ensures consistent quality, and fosters customer loyalty. Companies achieve 30% lower operational costs, 50% fewer defects, and proactive problem-solving capabilities.",
      subTitle: "READY TO TRANSFORM YOUR QUALITY MANAGEMENT?",
      subText:
        "Let our experts guide your TQM journey from assessment to certification.",
    },
    industries: [
    ...
    certification: {
      ...
      content:
        "We guide organizations through quality certification processes like the Deming Prize or ISO 9001, helping adopt TQM principles that meet prestigious award criteria and international standards.",
      process: [
    ...
    caseStudy: {
      ...
      content:
        "Reduced PPM defects from 4500 to 120 and improved OEE by 35% through structured TQM implementation, focusing on SPC, employee involvement, and supplier quality development.",
    },
    outcomes: {
      challenges: [
      ...
      items: [
        {
          ...
          answer:
            "TQM is a broad management philosophy focused on continuous improvement involving everyone. Six Sigma is a more specific, data-driven methodology focused on eliminating defects and reducing process variation, often using DMAIC or DMADV frameworks.",
        },
        {
          question: "Is TQM only for manufacturing?",
          answer:
            "No, TQM principles like customer focus, process improvement, and employee involvement are applicable and beneficial to service industries, healthcare, education, and government organizations as well.",
        },
        {
          question: "What is the PDCA cycle?",
          answer:
            "PDCA (Plan-Do-Check-Act) is a fundamental TQM cycle for continuous improvement. Plan the change, Do implement it (often on a small scale), Check the results, and Act to standardize the improvement or adjust the plan.",
        },
      ],
    },
  },
  ...
  "lean-manufacturing-consultants": {
    ...
    heroLayout: "split",
    heroBackgroundImage: "/images/servicesData/fhgjjlhjhg-1-1.jpg?id=30022",
    heroTitle: "LEAN MANUFACTURING | COST REDUCTION SERVICES",
    heroSubtitle: "Maximize Efficiency and Minimize Costs Through Waste Elimination",
    heroFeaturesList: [
    ...
    bannerSubtitle:
      "Maximize Efficiency and Minimize Costs Through Waste Elimination",
    bannerDescription:
      "Lean manufacturing focuses on systematically identifying and eliminating waste (Muda) within manufacturing systems while simultaneously maximizing productivity, quality, and value delivery to the customer.",
    ...
    whyChoose: {
      ...
      content:
        "Lean directly targets the root causes of inefficiency and high costs – the 'Seven Wastes' (plus Over-processing, Underutilized Talent). By eliminating waste, companies can reduce lead times, inventory, defects, and resource consumption, leading to substantial cost savings without compromising quality or customer value.",
      subTitle: "Ready to Cut Waste and Boost Profitability?",
      subText:
        "Let's identify your biggest cost-saving opportunities through Lean.",
    },
    pillars: [
      // Representing Lean Principles/Tools as Pillars
      {
        title: "Value Stream Mapping (VSM)",
        content:
          "Visualize the current state of material and information flow, identify waste, and design a leaner future state map to guide improvement efforts.",
      },
      {
        title: "5S Workplace Organization",
        content:
          "Implement Sort, Set in Order, Shine, Standardize, and Sustain to create a clean, organized, and efficient work environment, reducing search time and errors.",
      },
      {
        title: "Just-In-Time (JIT) / Kanban",
        content:
          "Produce and deliver only what is needed, when it is needed, and in the amount needed. Utilize pull systems (Kanban) to control inventory and reduce holding costs.",
      },
      {
        title: "Waste Elimination (Muda)",
        content:
          "Systematically identify and eliminate the 7+1 wastes: Defects, Overproduction, Waiting, Non-Utilized Talent, Transportation, Inventory, Motion, Extra-Processing.",
      },
      {
        title: "Continuous Improvement (Kaizen)",
        content:
          "Foster a culture where all employees are empowered to identify problems and implement small, incremental improvements regularly.",
      },
      {
        title: "Standardized Work",
        content:
          "Document and implement the best, safest, and most efficient way to perform each task, reducing variability and ensuring consistency.",
      },
    ],
    features: [
      // Representing Benefits as Features
      {
        icon: "TrendingDown",
        title: "Significant Cost Reduction",
        desc: "Reduce operational costs by 15-30% through targeted waste elimination.",
      },
      {
        icon: "Zap",
        title: "Improved Productivity",
        desc: "Increase output and resource efficiency by streamlining workflows.",
      },
      {
        icon: "Layers",
        title: "Reduced Inventory",
        desc: "Lower holding costs and free up cash flow with JIT and pull systems.",
      },
      {
        icon: "Clock",
        title: "Shorter Lead Times",
        desc: "Improve responsiveness to customer demand by reducing cycle times.",
      },
      {
        icon: "CheckSquare",
        title: "Enhanced Quality",
        desc: "Reduce defects and rework by building quality into the process (Poka-Yoke).",
      },
      {
        icon: "Maximize2",
        title: "Optimized Space",
        desc: "Improve facility layout and reduce footprint through better organization and flow.",
      },
    ],
    ...
    faq: {
      ...
      items: [
        {
          question: "What are the 'Seven Wastes' (Muda)?",
          answer:
            "Transportation, Inventory, Motion, Waiting, Overproduction, Over-processing, and Defects. An eighth waste, Non-Utilized Talent, is often added.",
        },
        {
          question: "Is Lean only about cost cutting?",
          answer:
            "While cost reduction is a major benefit, Lean is fundamentally about maximizing customer value by eliminating waste. This also leads to improvements in quality, lead time, flexibility, and employee morale.",
        },
        {
          question: "What is Value Stream Mapping (VSM)?",
          answer:
            "VSM is a tool used to visualize all the steps (both value-added and non-value-added) currently required to take a product or service from raw materials to the customer. It helps identify opportunities for improvement.",
        },
      ],
    },
  ...
  "manufacturing-operational-excellence-consulting": {
    ...
    whyChoose: {
      ...
      content:
        "OpEx moves beyond isolated improvements to create a holistic system for sustained success. It integrates strategy, processes, technology, and people to build competitive advantage, enhance customer satisfaction, increase agility, reduce operational risk, and drive long-term profitability.",
      subTitle: "Ready to Elevate Your Operations?",
      subText: "Let's build your roadmap to Operational Excellence together.",
    },
    pillars: [
      // Representing OpEx Focus Areas/Methodologies
      {
        title: "Lean Thinking",
        content:
          "Applying Lean principles to eliminate waste, improve flow, and maximize value throughout the organization.",
      },
      {
        title: "Six Sigma",
        content:
          "Utilizing DMAIC/DMADV methodologies and statistical tools to reduce variation, eliminate defects, and solve complex problems.",
      },
      {
        title: "Total Productive Maintenance (TPM)",
        content:
          "Integrating maintenance and production to maximize equipment effectiveness and reliability.",
      },
      {
        title: "Strategy Deployment (Hoshin Kanri)",
        content:
          "Aligning goals and initiatives across all levels of the organization to ensure focus on strategic priorities.",
      },
      {
        title: "Performance Management",
        content:
          "Establishing clear KPIs, visual management systems, and regular reviews to monitor progress and drive accountability.",
      },
      {
        title: "Leadership & Culture",
        content:
          "Developing leadership behaviors and fostering a culture that embraces continuous improvement, employee engagement, and customer focus.",
      },
    ],
    features: [
      // Representing OpEx Benefits
      {
        icon: "TrendingUp",
        title: "Breakthrough Performance",
        desc: "Achieve significant, sustainable improvements in key operational metrics (PQCDSM).",
      },
      {
        icon: "Target",
        title: "Strategic Alignment",
        desc: "Ensure operational activities directly support and execute business strategy.",
      },
      {
        icon: "Users",
        title: "Engaged Workforce",
        desc: "Build a culture of ownership, problem-solving, and continuous improvement.",
      },
      {
        icon: "RefreshCcw",
        title: "Process Optimization",
        desc: "Streamline end-to-end processes for maximum efficiency and effectiveness.",
      },
      {
        icon: "ShieldCheck",
        title: "Reduced Risk",
        desc: "Improve consistency, reliability, and safety across operations.",
      },
      {
        icon: "Award",
        title: "Competitive Advantage",
        desc: "Outperform competitors through superior operational capabilities and customer value.",
      },
    ],
    // Adding data for sections previously defined in page.js for OpEx
    improvementAreas: [
      // Assuming this exists based on page.js
      ...
      items: [
        {
          ...
          img: "/assets/images/industries/1.1.png",
        },
        {
          title: "Improve Quality (Reduce Defects)",
          img: "/assets/images/industries/2.2.png",
        },
        {
          title: "Reduce Operating Costs",
          img: "/assets/images/industries/3.3.png",
        },
        {
          title: "Enhance On-Time Delivery",
          img: "/assets/images/industries/4.4.png",
        },
        {
          title: "Improve Safety Performance",
          img: "/assets/images/industries/5.5.png",
        },
        {
          title: "Boost Employee Morale",
          img: "/assets/images/industries/6.6.png",
        },
      ],
    },
    challenges: {
      ...
      introText:
        "Organizations often face hurdles that prevent them from reaching peak performance. We help overcome these common issues:",
      items: [
        {
        ...
        {
          title: "Poor Quality / High Defects",
          img: "/assets/images/industries/2.2.png",
        },
        {
        ...
        {
          title: "Lack of Employee Engagement",
          img: "/assets/images/industries/5.5.png",
        },
        {
      ...
      outroText:
        "Our structured approach helps diagnose the root causes and implement effective, sustainable solutions.",
    },
    comparison: {
      // Assuming this exists based on page.js
      ...
      table: [
        {
          Feature: "Focus",
          Traditional: "Meeting Targets / Firefighting",
          OpEx: "Continuous Improvement / Flow",
        },
        {
          Feature: "Problem Solving",
          Traditional: "Reactive / Blame",
          OpEx: "Proactive / Root Cause Analysis",
        },
        {
          Feature: "Improvement",
          Traditional: "Occasional Projects",
          OpEx: "Daily / Employee Driven",
        },
        {
          Feature: "Culture",
          Traditional: "Top-Down / Siloed",
          OpEx: "Engaged / Collaborative",
        },
        {
          Feature: "Customer View",
          Traditional: "Internal Specs",
          OpEx: "Customer Value Driven",
        },
      ],
      textContent:
        "Operational Excellence represents a fundamental shift in how an organization operates, moving from reactive management to a proactive, systematic approach focused on long-term value creation and continuous improvement.",
    },
    feedback: {
      // Assuming this exists based on page.js
      title: "Client Success Stories",
      textContent:
        '"Working with the OpEx consultants transformed our shop floor. We reduced lead times by 40% and improved our first-pass yield significantly by implementing Lean principles and empowering our teams."',
    ...
    industriesServed: {
      // Assuming this exists based on page.js (different key name than TPM/TQM)
    ...
    caseStudies: {
      // Assuming this structure exists based on page.js
      ...
      studies: [
        {
          ...
          content:
            "Implemented cell-based manufacturing and pull systems, reducing WIP inventory by 60% and lead time by 50%.",
          challenges: [
            "Siloed departments",
            "High WIP inventory",
            "Long lead times",
          ...
          approach:
            "Value Stream Mapping, Cellular Layout Design, Kanban Implementation, Cross-functional Teams",
          results: [
            "WIP Reduced 60%",
        ...
        },
        {
          ...
          content:
            "Focused on TPM principles, particularly autonomous maintenance and focused improvement, increasing OEE from 55% to 75% on critical lines.",
          challenges: [
            "Frequent breakdowns",
            "Long changeovers",
          ...
          approach:
            "TPM Implementation (AM, PM, FI), SMED Workshops, Operator Training",
          results: [
            "OEE Increased by 20 points",
            "Breakdowns Reduced 40%",
            "Changeover Time Reduced 30%",
          ],
        },
      ],
    ...
    faq: {
      ...
      items: [
        {
          question: "How long does it take to achieve Operational Excellence?",
          answer:
            "OpEx is a journey, not a destination. Significant results can often be seen within months, but building a true OpEx culture takes sustained effort over years.",
        },
        {
          question: "What is the role of leadership in OpEx?",
          answer:
            "Leadership commitment is paramount. Leaders must set the vision, provide resources, remove barriers, empower employees, and lead by example in embracing continuous improvement.",
        },
        {
          question: "Can OpEx be applied outside manufacturing?",
          answer:
            "Absolutely. OpEx principles and methodologies are highly effective and adaptable to various environments, including service industries, healthcare, finance, logistics, government, and any organization seeking to improve its processes and deliver value.",
        },
      ],
    },
  },
  "manufacturing-excellence-consulting": {
    heroLayout: "split",
    heroTitle: "OPERATIONAL EXCELLENCE | MANUFACTURING CONSULTING",
    heroSubtitle: "Achieving Sustainable Peak Performance",
    heroBackgroundImage: "/assets/images/backgrounds/page-header-bg1.jpg",
    heroFeaturesList: [
  ...
  "iso-certification-consultants": {
    ...
    whyChoose: {
      ...
      subText:
        "Contact us to discuss how ISO standards can drive your business growth and global competitiveness.",
    },
    pillars: [
      {
        title: "Standardization",
        content:
          "Establish consistent processes and best practices across your organization, reducing variability and improving reliability.",
      },
      {
        title: "Customer Satisfaction (ISO 9001:2015)",
        content:
          "Meet and exceed customer requirements by implementing a robust Quality Management System.",
      },
      {
        title: "Process Improvement",
        content:
          "Describe, understand, and communicate your company’s processes to drive continual improvement and efficiency.",
      },
      {
        title: "Operational Consistency",
        content:
          "Improve the consistency of your operations, products, and services, reducing errors and rework.",
      },
      {
        title: "Energy Efficiency (ISO 50001:2018)",
        content:
          "Optimize energy use, reduce waste, and save money through systematic energy management.",
      },
      {
        title: "Collaboration & Recognition",
        content:
          "Facilitate business collaboration and gain international recognition with globally accepted standards.",
      },
      {
        title: "Workplace Safety (ISO 45001:2018)",
        content:
          "Enhance workplace safety, reduce occupational illness, and mitigate process risks.",
      },
      {
        title: "Specialized Standards",
        content:
          "Implement sector-specific standards such as ISO 13485 (Medical Devices) and ISO 22000 (Food Safety) for compliance and market access.",
      },
    ],
    features: [
      {
      ...
      items: [
        {
          ...
          answer:
            "The appropriate ISO standard depends on your industry, goals, and customer requirements. Common standards include ISO 9001 (Quality), ISO 14001 (Environment), ISO 45001 (Safety), ISO 50001 (Energy), ISO 13485 (Medical Devices), and ISO 22000 (Food Safety).",
        },
        {
          question: "How long does ISO certification take?",
          answer:
            "The timeline varies based on your organization’s size, complexity, and readiness. Typical implementation projects range from 3 to 12 months.",
        },
        {
          question: "What are the main benefits of ISO certification?",
          answer:
            "ISO certification improves process consistency, customer satisfaction, risk management, market access, and operational efficiency.",
        },
        {
          question: "Do you provide support during the certification audit?",
          answer:
            "Yes, Tetrahedron supports you throughout the entire process, including preparation for and support during the external certification audit.",
        },
        {
          question: "Can ISO standards be integrated?",
          answer:
            "Absolutely. Many organizations implement integrated management systems (IMS) to combine multiple ISO standards for greater efficiency and synergy.",
        },
      ],
    },
  },
  "visual-management-consultants": {
    ...
    heroLayout: "split",
    heroBackgroundImage: "/images/servicesData/Untitled-design-7.jpg?id=28428",
    heroTitle: "VISUAL MANAGEMENT CONSULTANTS",
    heroSubtitle: "Clarity | Efficiency | Engagement",
    heroFeaturesList: [
    ...
    pillars: [
      // Using 'pillars' for Key Elements/Principles
      {
        title: "Standardization",
        content:
          "Creating clear, visual standards for processes, layouts, and workflows ensures consistency and reduces ambiguity. Examples include standardized work instructions, color-coding, and labeled storage locations.",
      },
      {
        title: "Transparency",
        content:
          "Making performance metrics, project status, and potential issues readily visible to everyone involved. This fosters accountability and facilitates quick decision-making (e.g., performance dashboards, status boards).",
      },
      {
        title: "Built-in Quality",
        content:
          "Integrating visual quality checks and error-proofing (Poka-Yoke) mechanisms directly into the process helps detect and prevent defects at the source.",
      },
      {
        title: "Continuous Improvement",
        content:
          "Using visual cues to highlight problems, bottlenecks, and areas for improvement encourages ongoing refinement of processes (e.g., Andon systems, Kaizen boards).",
      },
      {
        title: "Safety Integration",
        content:
          "Employing visual signals, signs, and markings to clearly indicate hazards, safety procedures, and required personal protective equipment (PPE).",
      },
    ],
    features: [
      // Mapping to Benefits section
      {
        icon: "Eye",
    ...
    visualTools: {
      // Unique section for Visual Tools Examples
      ...
      items: [
        {
          ...
          answer:
            "Visual Management is a lean technique using visual signals to communicate information effectively, making processes, problems, and performance visible at a glance.",
        },
        {
          question: "How does Visual Management improve safety?",
          answer:
            "It improves safety by using clear visual cues like signs, labels, and floor markings for hazards, safety procedures, pathways, and emergency information, reducing risks and improving awareness.",
        },
        {
          question: "Is Visual Management only applicable to manufacturing?",
          answer:
            "No, while originating in manufacturing, Visual Management principles are highly effective and adaptable to various environments, including offices, healthcare, logistics, and service industries.",
        },
        {
          question:
            "What are the first steps to implementing Visual Management?",
          answer:
            "Typically, the first steps involve assessing the current state, identifying key areas for improvement (like safety, communication, or workflow), setting goals, and starting with foundational practices like 5S.",
        },
        {
          question: "How does Visual Management relate to 5S?",
          answer:
            "5S (Sort, Set in Order, Shine, Standardize, Sustain) is often a foundational element of Visual Management. 5S creates an organized workplace, and Visual Management builds upon this by adding visual controls and information displays.",
        },
      ],
    },
  },
  ...
  "manufacturing-excellence": {
    ...
    heroLayout: "split",
    heroBackgroundImage: "/images/servicesData/fhgjjlhjhg-1-1.jpg?id=30022",
    heroTitle: "MANUFACTURING EXCELLENCE CONSULTING",
    heroSubtitle: "Drive World-Class Performance Through Lean Principles",
    heroFeaturesList: [
    ...
    whyChoose: {
      ...
      content:
        "Manufacturing Excellence enables organizations to systematically eliminate waste, reduce costs, improve quality, and increase agility. By embedding Lean thinking and continuous improvement into your culture, you can sustain competitive advantage and deliver greater value to your customers.",
      subTitle: "Ready to Transform Your Manufacturing Operations?",
      subText:
        "Let's build your journey to world-class manufacturing together.",
    },
    pillars: [
      {
        title: "Value Stream Mapping (VSM)",
        content:
          "Visualize and analyze your end-to-end processes to identify waste and design a future state that maximizes value and flow.",
      },
      {
        title: "5S Workplace Organization",
        content:
          "Establish a clean, organized, and disciplined workplace to reduce waste, improve safety, and boost morale.",
      },
      {
        title: "Just-In-Time (JIT) / Kanban",
        content:
          "Implement pull systems to produce only what is needed, when it is needed, minimizing inventory and lead times.",
      },
      {
        title: "Waste Elimination (Muda)",
        content:
          "Target the 7+1 wastes (Defects, Overproduction, Waiting, Non-Utilized Talent, Transportation, Inventory, Motion, Over-Processing) to drive efficiency.",
      },
      {
        title: "Continuous Improvement (Kaizen)",
        content:
          "Foster a culture where everyone is engaged in identifying and implementing improvements every day.",
      },
      {
        title: "Standardized Work",
        content:
          "Document and sustain the best way to perform each task, ensuring consistency and enabling further improvement.",
      },
    ],
    features: [
      {
        icon: "TrendingDown",
        title: "Cost Reduction",
        desc: "Achieve 15-30% cost savings by eliminating waste and optimizing processes.",
      },
      {
        icon: "Zap",
        title: "Productivity Boost",
        desc: "Increase throughput and efficiency by streamlining workflows and removing bottlenecks.",
      },
      {
        icon: "Layers",
        title: "Inventory Optimization",
        desc: "Reduce inventory levels and free up working capital with JIT and Kanban.",
      },
      {
        icon: "Clock",
        title: "Faster Lead Times",
        desc: "Respond quickly to customer demand by reducing cycle times and improving flow.",
      },
      {
        icon: "CheckSquare",
        title: "Quality Improvement",
        desc: "Lower defects and rework by building quality into every process step.",
      },
      {
        icon: "Maximize2",
        title: "Space Utilization",
        desc: "Maximize your facility's footprint through better organization and flow.",
      },
    ],
    clients: {
    ...
    faq: {
      ...
      items: [
        {
          question: "What is Manufacturing Excellence?",
          answer:
            "Manufacturing Excellence is a holistic approach to achieving world-class performance by embedding Lean principles, continuous improvement, and operational discipline throughout the organization.",
        },
        {
          question: "How is Manufacturing Excellence different from Lean?",
          answer:
            "Lean is a core methodology within Manufacturing Excellence. Manufacturing Excellence also encompasses leadership, culture, and systems to sustain and amplify Lean improvements.",
        },
        {
          question: "What are the first steps to Manufacturing Excellence?",
          answer:
            "Start with a current state assessment, identify key wastes and improvement opportunities, and engage leadership and teams in Lean training and pilot projects.",
        },
      ],
    },
  },
  "plant-layout-design": {
    ...
    heroLayout: "split",
    heroBackgroundImage: "/images/servicesData/Untitled-design-44-1.jpg?id=30013",
    heroTitle: "PLANT LAYOUT DESIGN CONSULTANTS",
    heroSubtitle: "Optimize Flow | Maximize Space | Enhance Safety",
    heroFeaturesList: [
    ...
    whyChoose: {
      ...
      content:
        "Tetrahedron's consultants combine deep industrial engineering expertise with practical experience across various sectors. We utilize systematic methodologies and advanced tools like simulation to develop and validate layout designs that are not just theoretically optimal but also practical and implementable. Our focus is on creating layouts that enhance your operational performance, ensure safety, and provide long-term value.",
      subTitle: "Optimize Your Facility's Potential?",
      subText:
        "Contact us today to discuss how a professionally designed plant layout can streamline your operations and boost your bottom line.",
    },
    // Omitting 'industries' as it was an array of images in TPM/TQM and not directly equivalent here. Using 'clients' below.
    pillars: [
      // Using "Key Principles" as pillars
      {
        title: "Minimum Movement",
        content:
          "Designing the layout to minimize the distance materials and personnel need to travel, reducing handling time and costs.",
      },
      {
        title: "Flow",
        content:
          "Ensuring a smooth, logical progression of work, materials, and information through the process with minimal backtracking or congestion.",
      },
      {
        title: "Space Utilization",
        content:
          "Making the most effective use of available vertical and horizontal space, considering equipment footprint, movement, and storage needs.",
      },
      {
        title: "Safety & Satisfaction",
        content:
          "Creating a layout that ensures a safe working environment, minimizes hazards, and contributes to employee comfort and satisfaction.",
      },
      {
        title: "Flexibility",
        content:
          "Designing a layout that can adapt to changes in product design, production volume, technology, or processes with minimal disruption.",
      },
      {
        title: "Integration",
        content:
          "Ensuring all elements – machinery, personnel, material handling, support services – work together cohesively as a single, integrated system.",
      },
    ],
    features: [
      // Using "Importance/Benefits" as features
      {
    ...
    implementationProcess: {
      // Using similar structure to 'certification' or VM's implementation
    ...
    clients: {
     ...
     // image2: "/assets/images/layout_client2.jpeg",
    },
    faq: {
      // Common Section
      ...
      items: [
        {
          ...
          answer:
            "The primary objective is to arrange all physical facilities within a plant to ensure the most efficient and effective flow of materials, information, and people, minimizing costs and maximizing productivity and safety.",
        },
        {
          question: "How often should a plant layout be reviewed?",
          answer:
            "Layouts should be reviewed periodically (e.g., every few years) or whenever significant changes occur, such as new product introductions, volume changes, process modifications, or new technology adoption.",
        },
        {
          question: "What is Systematic Layout Planning (SLP)?",
          answer:
            "SLP is a structured methodology used for plant layout design. It involves analyzing relationships between activities (departments, machines), determining space requirements, and developing layout alternatives based on flow and adjacency needs.",
        },
        {
          question: "Can simulation help in plant layout design?",
          answer:
            "Yes, simulation modeling is a powerful tool to test and compare different layout alternatives under various operating conditions before physical implementation. It helps identify bottlenecks, evaluate performance metrics (like throughput, utilization), and validate the design.",
        },
        {
          question:
            "What is the difference between Product and Process Layout?",
          answer:
            "A Product Layout arranges resources in the sequence required for a specific product (like an assembly line), suitable for high volume. A Process Layout groups similar resources or functions together, suitable for high variety, lower volume production.",
        },
      ],
    },
  ...
  "dojo-training-center": {
    ...
    img: "/images/servicesData/dojoherosection.png?id=29158", // Matches format
    heroLayout: "split",
    heroBackgroundImage: "/images/servicesData/dojoherosection.png?id=29158",
    heroTitle: "DOJO TRAINING CENTRE",
    heroSubtitle: "Hands-On Skill Development | Practical Learning Environment",
    heroFeaturesList: [
      "A Dojo Training Centre is a dedicated space designed for immersive, hands-on learning and skill development, particularly focused on lean manufacturing principles, operational excellence, and specific job-related competencies."
    ],
    bannerTitle: "DOJO TRAINING CENTRE", // Matches format
    bannerSubtitle:
      "Hands-On Skill Development | Practical Learning Environment", // Matches format - slightly enhanced
    bannerDescription:
    ...
    whyChoose: {
      ...
      content:
        "Tetrahedron leverages its deep expertise in lean manufacturing, operational excellence, and adult learning principles to design and implement customized Dojo Training Centers. We understand that an effective Dojo is more than just a room; it's a dynamic learning ecosystem tailored to your specific operational needs and skill gaps. Our approach ensures your Dojo becomes a cornerstone for building a skilled, engaged, and continuously improving workforce.",
      subTitle: "Ready to Build a High-Impact Learning Environment?",
      subText:
        "Contact us to explore how a custom-designed Dojo Training Center can accelerate skill development and drive operational excellence within your organization.",
    },
    ...
    pillars: [
      // Matches format {title, content} - Using "Key Elements" as pillars
      {
        title: "Standardized Work Stations",
        content:
          "Dedicated areas mimicking actual workstations where employees can practice standard operating procedures (SOPs) repeatedly.",
      },
      {
        title: "Problem-Solving Zones",
        content:
          "Spaces equipped with tools (like whiteboards, A3 templates) for practicing root cause analysis and structured problem-solving methodologies (e.g., 5 Why, Fishbone).",
      },
      {
        title: "Kaizen & Continuous Improvement Area",
        content:
          "Facilitating hands-on practice of small, incremental improvements and lean principles application.",
      },
      {
        title: "Safety Simulation",
        content:
          "Areas focused on practicing safety protocols, hazard identification, lockout/tagout (LOTO), and emergency procedures in a safe environment.",
      },
      {
        title: "Quality Assurance Practice",
        content:
          "Stations for learning and practicing quality checks, defect identification, measurement techniques, and using quality tools.",
      },
      {
        title: "Visual Management Integration",
        content:
          "Incorporating visual controls, performance boards, and standardized communication methods as part of the learning process.",
      },
      {
        title: "Flexibility & Modularity",
        content:
          "Designing the Dojo space to be adaptable for different training modules, skill levels, and future needs.",
      },
    ],
    features: [
      // Matches format {icon, title, desc} - Using "Why is a Dojo Essential?" (Benefits) as features
      {
    ...
    implementationProcess: {
      // Matches format {title, process[], image?}
    ...
    clients: {
      // Using the generic client logo format 
      title: "Empowering Teams Across Industries", // Relevant title
      image: "/assets/images/dojo _client.jpeg", // Standard client logo image
    },
    faq: {
      // Matches format {title, items[]}
      ...
      items: [
        // Array of objects {question, answer}
        {
          ...
          answer:
            "The size depends on the number of participants, the types of skills being taught, and the equipment needed. It can range from a small dedicated room to a larger, multi-station area. We help determine the optimal size during the design phase.",
        },
        {
          question: "How long does it take to set up a Dojo?",
          answer:
            "The timeline varies based on complexity, but typically ranges from a few weeks for a simple setup to several months for a comprehensive, custom-built Dojo.",
        },
        {
          question: "Is a Dojo only for new employees?",
          answer:
            "No, Dojos are valuable for onboarding new hires, upskilling existing employees, cross-training personnel, reinforcing standards, and practicing new procedures or technologies.",
        },
        {
          question: "How do you measure the effectiveness of a Dojo?",
          answer:
            "Effectiveness can be measured through skill assessments (before/after), improved performance metrics (e.g., reduced errors, increased productivity, safety incidents), employee feedback, and observation of on-the-job application.",
        },
        {
          question: "Can a Dojo be virtual or digital?",
          answer:
            "While the core concept emphasizes hands-on practice, elements can be supplemented or adapted using virtual reality (VR), augmented reality (AR), and digital simulations, especially for complex or hazardous tasks. A hybrid approach is also common.",
        },
      ],
    },
  },
  ...
  "dojo-2-0": {
    // New entry for Dojo 2.0
    title: "DOJO 2.0: THE NEXT EVOLUTION IN SKILL DEVELOPMENT ",
    img: "/images/servicesData/dojoherosection.png",
    heroLayout: "split",
    heroBackgroundImage: "/images/servicesData/dojoherosection.png",
    heroTitle: "DOJO 2.0: THE NEXT EVOLUTION IN SKILL DEVELOPMENT",
    heroSubtitle: "Advanced Learning | Integrated Technology | Future-Ready Workforce",
    heroFeaturesList: [
      "Dojo 2.0 represents a significant advancement from traditional Dojo training centers, integrating digital technologies, advanced simulation, and data analytics to create a more dynamic, personalized, and impactful learning experience."
    ],
    // bannerTitle: "DOJO 2.0: THE NEXT EVOLUTION IN SKILL DEVELOPMENT",
    bannerSubtitle:
      "Advanced Learning | Integrated Technology | Future-Ready Workforce",
    bannerDescription:
      "Dojo 2.0 represents a significant advancement from traditional Dojo training centers, integrating digital technologies, advanced simulation, and data analytics to create a more dynamic, personalized, and impactful learning experience.",
    introText:
      "While the traditional Dojo focuses on hands-on practice of standardized work and basic lean principles, Dojo 2.0 elevates this concept by incorporating elements like Virtual Reality (VR), Augmented Reality (AR), IoT connectivity, and learning analytics.\nIt moves beyond basic skill repetition towards developing complex problem-solving abilities, adaptability, and proficiency with digital tools, preparing the workforce for the demands of Industry 4.0 and modern manufacturing environments. Dojo 2.0 aims to create a 'learning factory' environment that is deeply integrated with real-time operational data and future-focused skill requirements.",
    whyChoose: {
      title: "Why Partner with Tetrahedron for Your Dojo 2.0 Initiative?",
      content:
        "Tetrahedron is at the forefront of integrating advanced learning technologies with proven operational excellence methodologies. We help organizations transition from traditional training methods to sophisticated Dojo 2.0 environments. Our expertise spans instructional design, technology integration (VR/AR, IoT, Analytics), lean principles, and change management, ensuring your Dojo 2.0 investment delivers measurable improvements in skill, performance, and adaptability.",
      subTitle: "Ready to Future-Proof Your Workforce Skills?",
      subText:
        "Contact us to design and implement a cutting-edge Dojo 2.0 learning ecosystem tailored to your strategic objectives.",
    },
    ...
    comparisonDojo1vs2: {
      ...
      image:
        "/images/servicesData/WhatsApp-Image-2024-03-14-at-5.52.21-PM-900x577.jpeg", // Comparison image URL
      points: [
        // Array of comparison points
        {
          feature: "Focus",
          dojo1: "Basic skill repetition, Standard Work",
          dojo2: "Complex skills, adaptability, problem-solving",
        },
        {
          feature: "Technology",
          dojo1: "Primarily physical tools, mock-ups",
          dojo2: "VR/AR, IoT, sensors, digital twins, analytics",
        },
        {
          feature: "Learning Method",
          dojo1: "Repetitive practice, direct observation",
          dojo2:
            "Immersive simulation, data-driven feedback, personalized paths",
        },
        {
          feature: "Environment",
          dojo1: "Simulated physical stations",
          dojo2: "Hybrid physical-digital environment, 'Learning Factory'",
        },
        {
          feature: "Data Usage",
          dojo1: "Manual tracking, basic metrics",
          dojo2:
            "Real-time data collection, performance analytics, predictive insights",
        },
        {
          feature: "Scope",
          dojo1: "Specific tasks, operational basics",
          dojo2: "End-to-end processes, digital literacy, Industry 4.0 skills",
        },
        {
          feature: "Feedback",
          dojo1: "Instructor observation, peer review",
          dojo2:
            "System-generated data, biometric feedback (potential), AI analysis",
        },
      ],
    },

    pillars: [
      // Matches format {title, content} - Using "Key Features" as pillars
      {
        title: "Immersive Technologies (VR/AR)",
        content:
          "Utilizing Virtual and Augmented Reality for realistic, safe simulation of complex tasks, equipment operation, and hazardous scenarios.",
      },
      {
        title: "IoT & Sensor Integration",
        content:
          "Connecting training equipment and stations with sensors to gather real-time performance data and provide immediate feedback.",
      },
      {
        title: "Learning Analytics Platform",
        content:
          "Collecting and analyzing data on trainee performance, progress, and learning patterns to personalize training and identify areas for improvement.",
      },
      {
        title: "Digital Twin Integration",
        content:
          "Using virtual replicas of actual machines or processes for training, allowing experimentation without impacting live production.",
      },
      {
        title: "Personalized Learning Paths",
        content:
          "Leveraging data to create adaptive learning journeys tailored to individual trainee needs, skill levels, and learning pace.",
      },
      {
        title: "Advanced Problem-Solving Scenarios",
        content:
          "Simulating complex, multi-variable problems that require critical thinking, data analysis, and collaborative solutions.",
      },
      {
        title: "Cyber-Physical Systems Practice",
        content:
          "Training on the interaction between physical machinery and digital control systems, crucial for Industry 4.0.",
      },
    ],
    features: [
      // Matches format {icon, title, desc} - Using "Benefits" as features
      {
    ...
    implementationProcess: {
      ...
      image:
        "/images/servicesData/Screenshot-2024-06-01-at-11.54.35%E2%80%AFAM-725x1024.png", // Relevant image URL
    },
    // 'caseStudy' and 'outcomes' keys not applicable as no specific case study data provided.
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "Is Dojo 2.0 significantly more expensive than a traditional Dojo?",
          answer:
            "The initial investment for technology (VR/AR hardware, software licenses, sensors) can be higher. However, the potential ROI through faster training, reduced errors, improved safety, and less need for physical mock-ups often justifies the cost.",
        },
        {
          question:
            "What level of technical expertise is needed to manage a Dojo 2.0?",
          answer:
            "It requires personnel with skills in instructional technology, potentially VR/AR development or customization, data analysis, and IT support, in addition to traditional training/facilitation skills.",
        },
        {
          question: "Can existing Dojo centers be upgraded to Dojo 2.0?",
          answer:
            "Yes, often a phased approach is possible, starting by integrating digital elements like AR overlays or data dashboards into existing stations, then gradually adding more advanced simulations.",
        },
        {
          question: "What industries benefit most from Dojo 2.0?",
          answer:
            "Industries with complex assembly, high-risk operations, advanced machinery, stringent quality requirements, or those undergoing digital transformation (e.g., automotive, aerospace, pharmaceuticals, advanced manufacturing) see significant benefits.",
        },
        {
          question: "How is data privacy handled with learning analytics?",
          answer:
            "Implementing robust data governance policies is crucial. Data should be anonymized where possible, used ethically for improving training effectiveness, and comply with all relevant privacy regulations (like GDPR).",
        },
      ],
    },
  },
  ...
  "mini-dojo-training-center": { // New entry for Mini Dojo
    ...
    img: "/herosection-image/mini-dojo-1.png", // Matches format
    heroLayout: "split",
    heroBackgroundImage: "/herosection-image/mini-dojo-1.png",
    heroTitle: "MINI DOJO TRAINING CENTER",
    heroSubtitle: "Compact | Focused | Flexible Skill Development",
    heroFeaturesList: [
      "A Mini Dojo Training Centre offers a scaled-down, highly focused version of a traditional Dojo, designed for targeted skill development in specific areas using minimal space and resources."
    ],
    bannerTitle: "Mini Dojo Training Center", // Matches format
  ...
  "augmented-reality-virtual-reality": {
    ...
    img: "/AR-VR-Dojo.mp4",
    heroLayout: "split",
    heroBackgroundImage: "/AR-VR-Dojo.mp4",
    heroTitle: "Augmented Reality & Virtual Reality",
    heroSubtitle: "Immersive | Innovative | Transformative Experiences",
    heroFeaturesList: [
      "Explore how AR and VR technologies enhance learning, training, marketing, and healthcare by merging digital and real-world experiences."
    ],
    bannerTitle: "Augmented Reality & Virtual Reality",
    bannerSubtitle: "Immersive | Innovative | Transformative Experiences",
    bannerDescription:
      "Explore how AR and VR technologies enhance learning, training, marketing, and healthcare by merging digital and real-world experiences.",
    introText:
    ...
    whyChoose: {
      title: "Why Choose Tetrahedron for AR & VR Solutions?",
      content:
        "Tetrahedron designs customized AR & VR solutions tailored to your industry and objectives. From immersive training to interactive marketing, we provide expertise in integrating digital experiences that enhance engagement, learning, and operational efficiency.",
      subTitle: "Ready to Transform Your Experiences with AR & VR?",
      subText:
        "Contact us to discuss a personalized AR & VR strategy for your organization.",
    },
    ...
    pillars: [
      {
        ...
        content:
          "AR & VR allow users to experience realistic scenarios, enhancing understanding and skill acquisition.",
      },
      {
        title: "Enhanced Engagement",
        content:
          "Interactive experiences captivate learners, employees, and customers more effectively than traditional methods.",
      },
      {
        title: "Safe Simulation",
        content:
          "VR enables practicing complex or dangerous tasks in a risk-free virtual environment.",
      },
      {
        title: "Scalable & Flexible",
        content:
          "Solutions can be tailored to small groups or enterprise-wide deployment across multiple industries.",
      },
      {
        title: "Data-Driven Insights",
        content:
          "Track user interactions and performance to optimize training, marketing, or operational processes.",
      },
      {
        title: "Cost Efficiency",
        content:
          "Reduces physical resource requirements while providing high-value experiential learning or demonstrations.",
      },
    ],
    ...
    features: [
      {
        ...
        desc: "Overlay digital information onto real-world environments for guidance, training, or interactive experiences.",
      },
      {
        icon: "Headphones",
        title: "Virtual Reality",
        desc: "Immerse users completely in a simulated environment to safely practice skills or explore new experiences.",
      },
      {
        icon: "Building",
        title: "Industry Applications",
        desc: "Customized AR & VR solutions for manufacturing, healthcare, education, marketing, and more.",
      },
      {
        icon: "Play",
        title: "Engaging Experiences",
        desc: "Interactive simulations and visualizations make learning, training, and marketing more effective.",
      },
      {
        icon: "TrendingUp",
        title: "Performance Improvement",
        desc: "Enhance skill acquisition, employee engagement, and operational efficiency through immersive experiences.",
      },
      {
        icon: "Globe",
        title: "Global Scalability",
        desc: "Deploy AR & VR solutions across multiple locations, devices, or teams with consistent quality.",
      },
    ],

    implementationProcess: {
      title: "Implementing AR & VR Solutions: Our Approach",
      process: [
        "Assess Goals & Objectives: Identify the purpose of the AR/VR solution, whether for training, marketing, or customer engagement.",
        "Define Target Users: Determine the end-users and their environment for optimal experience design.",
        "Design Interactive Experiences: Create AR overlays, VR simulations, or mixed experiences tailored to user needs.",
        "Develop & Integrate: Build the solution using appropriate hardware, software, and platforms.",
        "Pilot & Test: Run initial sessions to gather feedback and optimize user experience.",
        "Deploy & Train: Roll out across teams or customer base with support and guidance.",
        "Evaluate & Iterate: Measure effectiveness and make improvements for engagement, learning, or operational impact.",
      ],
      image: "/assets/images/ar-vr-implementation.jpg",
    },

    useCases: {
      title: "AR & VR Use Cases Across Industries",
      items: [
        "Manufacturing: AR for training on complex machinery, VR for safe skill practice.",
        "Education: Immersive simulations for experiential learning, 360° subject visualization.",
        "Healthcare: AR-assisted procedures, VR for remote diagnostics or patient education.",
        "Marketing: AR product try-ons, VR experiences for customer engagement.",
        "Commerce: Virtual showrooms, immersive product demonstrations.",
        "Remote Collaboration: VR spaces for meetings and hands-on collaboration across locations.",
      ],
    },
      ...
      items: [
        {
          ...
          answer:
            "AR overlays digital content on the real world, while VR creates a completely immersive digital environment.",
        },
        {
          question: "Which industries can benefit from AR & VR?",
          answer:
            "Manufacturing, healthcare, education, marketing, commerce, and more can leverage AR & VR for training, engagement, and operational improvement.",
        },
        {
          question: "Do we need specialized devices?",
          answer:
            "AR can often be accessed via smartphones or tablets, while VR usually requires headsets. Tetrahedron advises on optimal hardware for your solution.",
        },
        {
          question: "Can AR & VR improve employee training?",
          answer:
            "Yes, immersive simulations allow employees to practice skills safely and retain knowledge better than traditional training methods.",
        },
        {
          question: "Is AR & VR cost-effective?",
          answer:
            "When implemented strategically, AR & VR reduces training costs, prevents errors, and enhances learning efficiency, providing strong ROI.",
        },
      ],
    },

    images: {
      // New field to include all your industry-specific images
      arImage: "/assets/images/ar.jpg",
      vrImage: "/assets/images/vr.jpg",
      manufacturingImage: "/assets/images/ar-vr-manufacturing.jpg",
      educationImage: "/assets/images/ar-vr-education.jpg",
      healthcareImage: "/assets/images/ar-vr-healthcare.jpg",
      marketingImage: "/assets/images/ar-vr-marketing.jpg",
    },
  },

  "dwm-and-time-management-techniques": {
    // New entry for DWM & Time Management Training
    ...
    keyFocusAreas: {
      ...
      items: [
        // List format for key areas covering both topics
        {
          icon: "ClipboardCheck",
          title: "DWM: Standard Work & Process Control",
        },
        ...
        { icon: "UserCheck", title: "DWM: Leader Standard Work Basics" },
        {
          icon: "ListTodo",
          title:
            "Time Mgmt: Prioritization Techniques (Eisenhower Matrix, etc.)",
        },
        {
          icon: "CalendarClock",
          title: "Time Mgmt: Effective Planning & Scheduling",
        },
        {
          icon: "UserMinus",
          title: "Time Mgmt: Managing Interruptions & Distractions",
        },
    ...
    targetAudience: {
      ...
      list: [
        // List format from page (likely similar to DWM audience, potentially broader)
    ...
    courseContent: {
      ...
      modules: [
        // List of modules/topics from page (structured logically, combining both)
    ...
    clients: {
      ...
      image: "/assets/images/training_client.jpeg",
       image2: "/assets/images/training_new.png", // Standard client logo image
    },
  ...
  digitization: {
    title: "Digitization in Manufacturing",
    img: "/images/corporate.png",
    heroLayout: "split",
    heroBackgroundImage: "/images/corporate.png",
    heroTitle: "Digitize Your Factory. Simplify Your Future.",
    heroSubtitle: "Smarter Operations | Real-Time Insights | Efficiency Boost",
    heroFeaturesList: [
      "Transform your manufacturing processes from paper-based to digital-first operations. Gain visibility, improve accuracy, and empower your workforce with modern digital tools."
    ],
    bannerTitle: "Digitize Your Factory. Simplify Your Future.",
    bannerSubtitle:
      "Smarter Operations | Real-Time Insights | Efficiency Boost",
    bannerDescription:
      "Transform your manufacturing processes from paper-based to digital-first operations. Gain visibility, improve accuracy, and empower your workforce with modern digital tools.",

    introText:
      "The manufacturing industry is evolving faster than ever. From automation on the factory floor to data-driven decision-making, companies are adopting new technologies to improve efficiency, quality, and performance. One of the most important steps in this transformation is going paperless — replacing outdated manual systems with digital tools that can track and manage operations in real time.\n\nThis is where digitization in manufacturing comes in. In simple terms, digitization is the process of converting paper-based systems into digital formats using modern technologies. Done right, it leads to smarter production, more efficient workers, and greater accuracy at every stage of the process.",

    whyChoose: {
      title: "Why is Digitization Important in Manufacturing?",
      content:
        "Paper-based reporting is slow, error-prone, and difficult to update. Procedures written on paper often sit on a desk long after they’re outdated, causing confusion and costly mistakes on the shop floor. Digitization solves this problem by keeping your processes updated, accessible, and consistent, ensuring workers always have the right instructions, managers have real-time visibility, and businesses can respond quickly to change.",
      subTitle: "Key Benefits of Digitization",
      subText:
        "• Real-time access to operational data and analytics\n• Easier process monitoring and tracking\n• Consistency across production procedures\n• Better collaboration between humans and machines\n• Reduced errors and rework, saving time and costs",
    },
    ...
    pillars: [
      {
        ...
        content:
          "Access operational data instantly to make faster, more informed decisions.",
      },
      {
        title: "Process Accuracy",
        content:
          "Digital systems reduce errors and ensure consistency across production workflows.",
      },
      {
        title: "Efficiency & Productivity",
        content:
          "Streamlined processes and automation free workers to focus on higher-value tasks.",
      },
      {
        title: "Smarter Collaboration",
        content:
          "Seamless interaction between humans, machines, and systems to optimize production.",
      },
      {
        title: "Enhanced Safety",
        content:
          "Digitization helps prevent mistakes and reduces workplace risks by providing up-to-date instructions and monitoring.",
      },
      {
        title: "Future-Ready Operations",
        content:
          "Prepare your factory for Industry 4.0 with connected, digital-first systems.",
      },
    ],
    ...
    features: [
      {
        ...
        desc: "Replace paper manuals with easily updatable digital instructions for consistent performance.",
      },
      {
        icon: "Smartphone",
        title: "Connected Worker Platforms",
        desc: "Enable workers to track tasks, report issues, and access procedures from mobile devices.",
      },
      {
        icon: "Monitor",
        title: "Real-Time Monitoring",
        desc: "Use IoT sensors and dashboards to track production, machine health, and operational KPIs.",
      },
      {
        icon: "Zap",
        title: "Automation",
        desc: "Streamline scheduling, reporting, and workflow processes to reduce manual effort.",
      },
      {
        icon: "TrendingUp",
        title: "Smarter Decision-Making",
        desc: "Leverage data analytics to continuously optimize production efficiency and quality.",
      },
      {
        icon: "Globe",
        title: "Scalable Solutions",
        desc: "Apply digital tools across multiple sites, teams, or production lines with consistency.",
      },
    ],

    implementationProcess: {
      title: "How to Digitize Manufacturing Processes",
      process: [
        "Evaluate Current Systems: Identify outdated reporting methods, paper-based SOPs, and workflows that cause waste or defects.",
        "Digitize Everyday Operations: Convert work instructions, forms, and SOPs into digital versions for easy updates and access.",
        "Adopt Smart Technologies: Integrate IoT devices, connected worker platforms, and analytics tools to monitor production in real time.",
        "Automate Where Possible: Streamline scheduling, work orders, and reporting to reduce manual effort and focus workers on high-value tasks.",
        "Train Workforce: Provide guidance to employees on using digital tools effectively for safer and more efficient operations.",
        "Monitor & Optimize: Continuously track performance, identify gaps, and refine digital processes for maximum productivity.",
      ],
      image: "/assets/images/servicesData/digitization-process.jpg",
    },

    useCases: {
      title: "The Future of Digitization in Manufacturing",
      items: [
        "Digital work instructions that replace paper-based manuals",
        "Automated scheduling and monitoring of work orders",
        "Smarter training and skills management",
        "Faster onboarding and knowledge sharing across teams",
        "Real-time machine and process insights",
      ],
    },

    clients: {
      title: "Partner with Us for Your Digital Journey",
      image: "/assets/images/client.jpg",
    },

    faq: {
      title: "Digitization in Manufacturing FAQs",
      items: [
        {
          question: "What is manufacturing digitization?",
          answer:
            "Digitization in manufacturing is the process of converting paper-based systems into digital formats using modern technologies for real-time tracking, analysis, and optimization.",
        },
        {
          question: "Why is digitization important?",
          answer:
            "It ensures processes are updated, consistent, and accessible, reduces errors, enhances collaboration, and improves efficiency across production lines.",
        },
        {
          question: "How do we get started?",
          answer:
            "Evaluate current processes, digitize instructions and workflows, adopt smart technologies, automate where possible, train the workforce, and monitor outcomes.",
        },
        {
          question: "Can small factories benefit from digitization?",
          answer:
            "Yes, digitization can scale to any size operation, improving accuracy, productivity, and visibility regardless of factory size.",
        },
        {
          question: "What ROI can we expect?",
          answer:
            "Benefits include reduced errors and rework, improved productivity, faster training, better compliance, and data-driven decision-making leading to measurable ROI.",
        },
      ],
    },

    cta: {
      primary: { label: "Get Started Today", link: "/contact" },
      secondary: { label: "Book a Consultation", link: "/contact" },
    },

    images: {
      heroImage: "/assets/images/digitization-hero.jpg",
      digitizationGraphic: "/assets/images/digitization-graphic.jpg",
      processImage: "/assets/images/digitization-process.jpg",
    },
  },

  "smart-factory": {
    title: "Smart Factory Solutions",
    img: "/herosection-image/Smart factory.png",
    heroLayout: "split",
    heroBackgroundImage: "/herosection-image/Smart factory.png",
    heroTitle: "Transforming Industries with Smart Factory Solutions",
    heroSubtitle: "Efficiency | Automation | Digital Transformation",
    heroFeaturesList: [
      "Empower your manufacturing processes with intelligent, connected, and automated systems. Make smarter decisions, reduce downtime, and operate at peak efficiency."
    ],
    bannerTitle: "Transforming Industries with Smart Factory Solutions",
    bannerSubtitle: "Efficiency | Automation | Digital Transformation",
    bannerDescription:
      "Empower your manufacturing processes with intelligent, connected, and automated systems. Make smarter decisions, reduce downtime, and operate at peak efficiency.",

    introText:
      "A Smart Factory is more than just an automated production line — it’s a fully connected ecosystem where machines, people, and systems work together seamlessly. By combining automation, IoT, AI, and real-time data, Smart Factories empower businesses to optimize production, reduce downtime, and operate more efficiently. In simple terms, it’s faster, safer, and smarter manufacturing.",

    whyChoose: {
      title: "Why Choose a Smart Factory?",
      content:
        "Traditional manufacturing often faces inefficiencies, downtime, and inconsistent quality due to manual processes and disconnected systems. Smart Factories overcome these challenges by connecting machines, people, and processes, providing real-time visibility, predictive insights, and automation.",
      subTitle: "Key Benefits of Smart Factories",
      subText:
    ...
    pillars: [
      {
        ...
        content:
          "Advanced robots and automated systems handle repetitive tasks with speed, accuracy, and consistency.",
      },
      {
        title: "IoT & Real-Time Monitoring",
        content:
          "Connect machines, devices, and systems to track performance and detect issues instantly.",
      },
      {
        title: "Artificial Intelligence & Machine Learning",
        content:
          "Analyze data patterns to optimize production, predict failures, and improve decision-making.",
      },
      {
        title: "Predictive Maintenance",
        content:
          "Predict equipment issues before they happen to save time and costly repairs.",
      },
      {
        title: "Data Analytics & Cloud Integration",
        content:
          "Centralize data for KPI monitoring, workflow optimization, and demand forecasting.",
      },
      {
        title: "Energy Efficiency & Sustainability",
        content:
          "Reduce waste, cut costs, and support eco-friendly manufacturing practices.",
      },
    ],
    ...
    features: [
      {
        icon: "Robot",
        title: "Automation & Robotics",
        desc: "Replace repetitive manual tasks with smart robots and automated systems.",
      },
      {
        icon: "Monitor",
        title: "IoT & Real-Time Monitoring",
        desc: "Track machine health, performance, and production metrics live.",
      },
      {
        icon: "Cpu",
        title: "AI & Machine Learning",
        desc: "Optimize processes and predict failures using intelligent algorithms.",
      },
      {
        icon: "Tools",
        title: "Predictive Maintenance",
        desc: "Prevent downtime with proactive maintenance strategies.",
      },
      {
        icon: "Cloud",
        title: "Data Analytics & Cloud Integration",
        desc: "Leverage centralized analytics to optimize efficiency and planning.",
      },
      {
        icon: "Leaf",
        title: "Energy Efficiency & Sustainability",
        desc: "Minimize resource use while supporting sustainable practices.",
      },
    ],

    implementationProcess: {
      title: "How to Implement a Smart Factory",
      process: [
        "Assess Current Operations: Identify inefficiencies, manual processes, and bottlenecks.",
        "Connect Machines & Systems: Implement IoT devices and networked production equipment.",
        "Integrate AI & Automation: Apply intelligent systems to optimize workflows and predictive maintenance.",
        "Centralize Data & Analytics: Collect and analyze operational data in real-time.",
        "Train Workforce: Enable employees to use connected systems effectively.",
        "Monitor & Improve: Continuously evaluate performance and refine processes.",
      ],
      image: "/images/smart-factory1.png",
    },

    useCases: {
      title: "Applications Across Industries",
      items: [
        "Automotive – smarter assembly lines and quality control",
        "Electronics – precision-driven production with minimal errors",
        "FMCG – high-volume, consistent, and reliable output",
        "Logistics & Warehousing – automated handling and real-time tracking",
        "Pharmaceuticals – compliance, accuracy, and traceability",
        "Heavy Industries – safer operations with predictive monitoring",
      ],
    },

    clients: {
      title: "Partner with Us for Your Smart Factory Journey",
      image: "/assets/images/client.jpg",
    },

    faq: {
      title: "Smart Factory FAQs",
      items: [
        {
          question: "What is a Smart Factory?",
          answer:
            "A Smart Factory is a fully connected manufacturing ecosystem that leverages automation, IoT, AI, and real-time data to optimize production and reduce downtime.",
        },
        {
          question: "Why implement a Smart Factory?",
          answer:
            "To improve efficiency, ensure consistent product quality, reduce operational costs, and enable smarter, data-driven decisions.",
        },
        {
          question: "How do we get started?",
          answer:
            "Assess current processes, integrate IoT and automation, implement AI systems, train your workforce, and monitor performance continuously.",
        },
        {
          question: "Can small factories benefit?",
          answer:
            "Yes, Smart Factory solutions scale to any size, improving visibility, productivity, and decision-making.",
        },
        {
          question: "What ROI can we expect?",
          answer:
            "Benefits include reduced downtime, improved efficiency, cost savings, higher quality, and actionable insights leading to measurable ROI.",
        },
      ],
    },
    ...
    images: {
      heroImage: "/images/smart-factory1.png",
      smartFactoryGraphic: "/assets/images/smart-factory-graphic.jpg",
      processImage: "/assets/images/servicesData/smart-factory-process.jpg",
    },
  },

  "iso-9001-qms": {
    // New entry for ISO 9001 QMS
    ...
    whyChoose: {
      ...
      subTitle:
        "Ready to achieve ISO 9001 Certification and Elevate Your Quality Standards?",
      subText:
        "Contact us for a consultation to understand how we can assist you in building an effective QMS.",
    },
    // 'industries' key not applicable. Using 'clients' later.

    pillars: [
      // Matches format {title, content} - Using "Key Principles" as pillars
      {
        title: "Customer Focus",
        content:
          "Understanding and meeting customer needs and expectations is paramount.",
      },
      {
        title: "Leadership",
        content:
          "Top management commitment and direction are essential for QMS effectiveness.",
      },
      {
        title: "Engagement of People",
        content:
          "Competent, empowered, and engaged employees at all levels are crucial.",
      },
      {
        title: "Process Approach",
        content:
          "Managing activities as interrelated processes produces consistent and predictable results.",
      },
      {
        title: "Improvement",
        content:
          "Successful organizations have an ongoing focus on continual improvement.",
      },
      {
      ...
      },
      {
        ...
        content:
          "Managing relationships with interested parties (suppliers, partners) is vital for sustained success.",
      },
    ],
    features: [
      // Matches format {icon, title, desc} - Using "Benefits" as features
    ...
    implementationProcess: {
      ...
      image:
        "/images/servicesData/WhatsApp-Image-2023-03-03-at-14.37.36-jpg.webp", // Relevant image URL
    },
    // 'caseStudy' and 'outcomes' keys not applicable.
    ...
    coreConcepts: {
      ...
      image:
        "/images/servicesData/WhatsApp-Image-2023-03-03-at-14.37.36-jpg.webp", // Image for concepts
      items: [
        // Array of objects {title, desc}
        {
    ...
    faq: {
      ...
      items: [
        // Array of objects {question, answer}
        {
          ...
          answer:
            "The current version is ISO 9001:2015, published in September 2015.",
        },
        {
          question: "Is ISO 9001 mandatory?",
          answer:
            "No, ISO 9001 certification is voluntary. However, it is often a customer requirement or a prerequisite for participating in certain tenders or industries.",
        },
        {
          question: "How long does it take to get ISO 9001 certified?",
          answer:
            "The timeline varies depending on the organization's size, complexity, and existing systems, but typically ranges from 6 to 18 months.",
        },
        {
          question:
            "What is the difference between ISO 9001 certification and accreditation?",
          answer:
            "Certification is awarded to an organization by a Certification Body (Registrar) confirming its QMS meets ISO 9001 standards. Accreditation is the formal recognition of a Certification Body's competence by an Accreditation Body.",
        },
        {
          question: "Does ISO 9001 require specific software?",
          answer:
            "No, the standard does not mandate specific software. However, QMS software can help manage documentation, records, audits, and corrective actions more efficiently.",
        },
      ],
    },
  },
  ...
  "iso-45001-consultancy": {
    ...
    whyChoose: {
      ...
      subTitle:
        "Ready to prioritize workplace safety and achieve ISO 45001 Certification?",
      subText:
        "Contact us to discuss how we can help you build a robust OH&S Management System.",
    },
    // 'industries' key not applicable.
    ...
    pillars: [
      // Matches format {title, content} - Using "Key Elements" as pillars
      {
        ...
        content:
          "Understanding internal/external issues, needs of workers and interested parties relevant to OH&S.",
      },
      {
        title: "Leadership & Worker Participation",
        content:
          "Top management commitment, clear OH&S policy, defined roles, and consultation/participation of workers.",
      },
      {
        title: "Planning",
        content:
          "Addressing risks/opportunities, hazard identification, legal requirements, and setting OH&S objectives.",
      },
      {
        title: "Support",
        content:
          "Providing necessary resources, ensuring competence, awareness, communication, and documented information.",
      },
      {
        title: "Operation",
        content:
          "Operational planning and control, eliminating hazards, managing change, procurement, contractors, and emergency preparedness.",
      },
      {
        title: "Performance Evaluation",
        content:
          "Monitoring, measurement, analysis, evaluation of compliance, internal audits, and addressing nonconformities.",
      },
      {
        title: "Improvement",
        content:
          "Addressing incidents and nonconformities, corrective actions, and driving continual improvement of the OH&S system.",
      },
    ],
    features: [
      // Matches format {icon, title, desc} - Using "Benefits" as features
    ...
    faq: {
      ...
      items: [
        // Array of objects {question, answer}
        {
          ...
          answer:
            "ISO 45001:2018 replaced OHSAS 18001 as the primary international standard for occupational health and safety management.",
        },
        {
          question: "Is ISO 45001 certification required by law?",
          answer:
            "No, like ISO 9001, certification to ISO 45001 is voluntary. However, compliance with underlying OH&S laws and regulations IS mandatory, and ISO 45001 helps achieve this.",
        },
        {
          question:
            "Can ISO 45001 be integrated with other management systems like ISO 9001 or ISO 14001?",
          answer:
            "Yes, ISO 45001 shares the same high-level structure (Annex SL) as other major ISO management system standards, making integration relatively straightforward.",
        },
        {
          question: "What is the role of top management in ISO 45001?",
          answer:
            "Top management has ultimate responsibility for the OH&S system. Their roles include demonstrating leadership and commitment, ensuring the OH&S policy and objectives are set, integrating OH&S into business processes, and ensuring necessary resources are available.",
        },
        {
          question: "How does ISO 45001 address mental health?",
          answer:
            "While not explicitly detailing 'mental health' programs, the standard requires organizations to identify and control risks related to psychosocial factors in the workplace (e.g., workload, stress, harassment) as part of overall worker well-being.",
        },
      ],
    },
  },
  ...
  "iso-50001-enms": {
    ...
    whyChoose: {
      ...
      subTitle:
        "Ready to take control of your energy consumption and achieve ISO 50001 Certification?",
      subText:
        "Contact us to learn how an EnMS can drive efficiency and cost savings for your organization.",
    },
    // 'industries' key not applicable.
    ...
    pillars: [
      // Matches format {title, content} - Using "Key Elements" as pillars
      {
        ...
        content:
          "Top management commitment, energy policy, defined roles, and resource allocation.",
      },
      {
        title: "Energy Planning",
        content:
          "Energy review (analysis of use/consumption), energy baseline, energy performance indicators (EnPIs), objectives, targets, and action plans.",
      },
      {
        title: "Implementation & Operation",
        content:
          "Competence, training, awareness, communication, documentation, operational control, design considerations, and procurement of energy services/products/equipment.",
      },
      {
        title: "Checking",
        content:
          "Monitoring, measurement, analysis of energy performance, evaluation of legal compliance, internal audits, and addressing nonconformities.",
      },
      {
        title: "Management Review",
        content:
          "Regular review of the EnMS by top management to ensure its continuing suitability, adequacy, and effectiveness.",
      },
      {
        title: "Continual Improvement",
        content:
          "Ongoing enhancement of energy performance and the EnMS itself, based on the PDCA cycle.",
      },
    ],
    features: [
      // Matches format {icon, title, desc} - Using "Benefits" as features
    ...
    clients: {
      ...
      image:
        "/images/servicesData/WhatsApp-Image-2023-03-03-at-14.37.36-jpg.webp", // Standard client logo image
    },
    faq: {
      // Matches format {title, items[]}
      ...
      items: [
        // Array of objects {question, answer}
        {
          ...
          answer:
            "An energy audit is typically a one-time assessment identifying savings opportunities. ISO 50001 provides a continuous management system framework to sustain energy performance improvements over time, often incorporating regular energy audits within its structure.",
        },
        {
          question: "Is ISO 50001 only for large, energy-intensive industries?",
          answer:
            "No, while energy-intensive industries see large benefits, any organization seeking to manage energy costs and improve efficiency can benefit from ISO 50001, regardless of size or sector.",
        },
        {
          question: "Does ISO 50001 mandate specific energy reduction targets?",
          answer:
            "No, the standard requires organizations to set their *own* objectives and targets for improving energy performance based on their context, baseline, and opportunities.",
        },
        {
          question:
            "How does ISO 50001 relate to ISO 14001 (Environmental Management)?",
          answer:
            "They are complementary. ISO 14001 addresses broader environmental impacts, while ISO 50001 focuses specifically on energy performance. They share the same high-level structure (Annex SL), facilitating integration.",
        },
        {
          question: "What are Energy Performance Indicators (EnPIs)?",
          answer:
            "EnPIs are metrics chosen by the organization to track energy performance. Examples include kWh per unit produced, energy consumption per square foot, or boiler efficiency (%). They are crucial for demonstrating improvement.",
        },
      ],
    },
  },
  ...
  "energy-audit-and-efficiency-services": {
    ...
    bannerSubtitle:
      "Identify Savings | Optimize Consumption | Enhance Sustainability", // Matches format - derived from content
    bannerDescription:
    ...
    whyChoose: {
      ...
      subTitle:
        "Ready to uncover hidden energy savings potential in your facility?",
      subText:
        "Contact us to schedule an energy audit tailored to your specific needs.",
    },
    // 'industries' key not applicable.
    ...
    faq: {
      ...
      items: [
        // Array of objects {question, answer}
        {
          ...
          answer:
            "The duration depends on the size and complexity of the facility and the type (Level 1, 2, or 3) of audit. It can range from a few days for a walk-through to several weeks or months for an investment-grade audit.",
        },
        {
          question: "What qualifications should an energy auditor have?",
          answer:
            "Look for certified energy auditors (e.g., BEE Certified Energy Auditor in India, CEM internationally) or accredited energy service companies (ESCOs) with relevant engineering backgrounds and industry experience.",
        },
        {
          question:
            "What is the typical payback period for energy efficiency projects identified in an audit?",
          answer:
            "Payback periods vary widely. Low-cost/no-cost measures often have immediate payback. Simple retrofits might have paybacks of 1-3 years, while major capital projects could range from 3-7 years or more.",
        },
        {
          question:
            "Is an energy audit required before implementing ISO 50001?",
          answer:
            "While not explicitly mandated by the standard name, the 'Energy Review' required by ISO 50001 is effectively an energy audit process. Conducting a thorough audit is a fundamental first step for establishing an effective EnMS.",
        },
        {
          question: "How much does an energy audit cost?",
          answer:
            "The cost depends on the audit level, facility size, complexity, and scope. Level 1 audits are the least expensive, while Level 3 audits require the most significant investment.",
        },
      ],
    },
  },
  ...
  "automated-guided-vehicle-manufacturers": {
    ...
    bannerSubtitle:
      "Streamlining Material Handling with Intelligent Automation", // Matches format (from page)
    bannerDescription:
    ...
    whyChoose: {
      ...
      subText:
        "Contact us to discuss your requirements and explore the possibilities of AGV technology for your operations.",
    },
    // 'industries' key not applicable.
    ...
    agvTypes: {
      ...
      items: [
        // Array of objects {title, desc, img}
        {
    ...
    features: [
      // Matches format {icon, title, desc} - Using "Key Features & Benefits" as features
      {
        icon: "TrendingUp", // Lucide icon guess
    ...
    technologyComponents: {
      ...
      items: [
        // Array of strings or {title, desc} if descriptions were longer
    ...
    implementationProcess: {
      // Matches format {title, process[], image?} - Adapted for Consulting/Integration
      ...
      image:
        "/images/servicesData/WhatsApp-Image-2024-06-14-at-4.49.32-PM.jpeg", // Relevant image URL
    },
    // 'caseStudy' and 'outcomes' keys not applicable.
    ...
    faq: {
      ...
      items: [
        // Array of objects {question, answer}
        {
          ...
          answer:
            "Traditionally, AGVs follow fixed paths (magnetic tape, wires, lasers reflecting off targets). AMRs typically use more advanced onboard intelligence (like SLAM) to navigate dynamically, rerouting around obstacles without fixed infrastructure. The lines are blurring as technologies converge.",
        },
        {
          question: "How do AGVs navigate?",
          answer:
            "Common methods include magnetic tape/wire guidance, laser triangulation (using reflectors), vision guidance (recognizing features), contour navigation (LiDAR mapping), and sometimes GPS for outdoor use.",
        },
        {
          question: "Are AGVs safe to operate around people?",
          answer:
            "Yes, modern AGVs are equipped with extensive safety systems, including laser scanners, bumpers, emergency stops, and audible/visual warnings, allowing them to operate safely alongside human workers when properly implemented.",
        },
        {
          question: "What is the typical lifespan of an AGV?",
          answer:
            "With proper maintenance, AGVs can have a lifespan of 10-15 years or more, although battery replacement is typically needed sooner.",
        },
        {
          question: "How much does an AGV system cost?",
          answer:
            "Costs vary significantly based on AGV type, quantity, navigation technology, load capacity, software complexity, and integration requirements. A detailed feasibility study is needed for accurate cost estimation.",
        },
      ],
    },
  },
...
export const skillTrainingData = {
  ...
  "advanced-product-quality-planning": {
    ...
    image: "/herosection-image/ADVANCED PRODUCT QUALITY PLANNING (APQP).png", // From page header background style
    ...
    pillars: [
      // Using 'pillars' for the 5 Phases of APQP
      ...
      },
      {
        ...
        content:
          "The final phase concentrates on ongoing evaluation and continuous improvement during full production. It involves monitoring process performance, focusing on reducing variation, enhancing customer satisfaction through feedback loops, utilizing lessons learned for future projects, and implementing corrective actions as needed.", // From phase list item description
    ...
    courseContent: {
      ...
      modules: [
        // List of modules/topics from page
    ...
    clients: {
      // Using the generic client logo format if specific ones aren't listed for APQP
      title: "Trusted by Industry Leaders for Quality Training", // Relevant title
      image: "/assets/images/training_client.jpeg",
      image2: "/assets/images/training_new.png",  // Standard client logo image placeholder unless a specific one is on the page
      logos: [
        
        // Assuming a standard client logo carousel/section might exist
    ...
    form: {
      // Added form section based on typical training pages
      title: "Register Your Interest / Request a Quote",
      description:
        "Fill out the form below to learn more about our APQP training, request a customized quote for your team, or inquire about upcoming public batches.",
  ...
  "measurement-system-analysis-msa": {
    // New entry for MSA Training
    // Mapping training content to the consulting structure where possible, adding new keys as needed.
    title: "Measurement System Analysis (MSA) Training", // From page <title> and H1
    image: "/herosection-image/measurement-system-analysis-msa-training.png",
    heroBackgroundImage: "/herosection-image/measurement-system-analysis-msa-training.png",
    bannerTitle: "MEASUREMENT SYSTEM ANALYSIS (MSA)", // From H1 in page header
    bannerSubtitle:
      "Ensuring Data Integrity through Measurement System Validation", // Synthesized from page content/purpose
    bannerDescription:
      "Master the principles and techniques of Measurement System Analysis (MSA) with our comprehensive training. Equip your team to quantify measurement system variation, ensure data reliability, make informed decisions based on accurate measurements, and comply with industry standards like IATF 16949.", // Derived and expanded from introductory paragraphs
    introText:
    ...
    pillars: [
      // Using 'pillars' for Key Concepts in MSA
      // Title added for the section
      {
        title: "Key Concepts in Measurement System Analysis",
        isSectionTitle: true,
      }, // Synthesized section title
      // Image related to the pillars/concepts
      {
        image:
          "/assets/images/corporate-training/technical-training/msa-concepts.jpg",
        isImage: true,
      }, // Specific image found on page: msa-concepts.jpg (verify path)
      {
        title: "Bias (Accuracy)", // From Key Concepts list
        content:
          "The difference between the observed average measurement and a reference value (true or master value). It assesses the systematic error of the measurement system.", // From Key Concepts list description
        icon: "Target", // Lucide icon guess for Accuracy/Bias
      },
      {
        title: "Linearity", // From Key Concepts list
        content:
          "The consistency of bias across the expected operating range of the gauge. It checks if the measurement system's accuracy changes at different measurement levels.", // From Key Concepts list description
        icon: "TrendingUp", // Lucide icon guess for Linearity (range consistency)
      },
      {
        title: "Stability", // From Key Concepts list
        content:
          "The consistency of measurements obtained with a measurement system over time on the same master or parts. It assesses drift or changes in bias over extended periods.", // From Key Concepts list description
      ...
      },
      {
        ...
        content:
          "The variation observed when the same operator measures the same part multiple times using the same gauge under identical conditions. It represents within-system variation.", // From Key Concepts list description
        icon: "Repeat", // Lucide icon guess for Repeatability
      },
      {
        title: "Reproducibility (Appraiser Variation - AV)", // From Key Concepts list
        content:
          "The variation in the average of measurements made by different operators using the same gauge when measuring the identical characteristic on the same part. It represents variation between operators/setups.", // From Key Concepts list description
      ...
      },
      {
        ...
        content:
          "A statistical study quantifying the combined variation from Repeatability and Reproducibility within a measurement system, usually expressed as a percentage of process variation or tolerance.", // Synthesized description
    ...
    methodology: {
      title: "Training Methodology", // From section heading
      image:
        "/images/servicesData/Add-a-heading-2.jpg", // Specific image found on page: training-methodology.jpg (verify path)
      points: [
        // List of methodology points
    ...
    clients: {
      // Using the generic client logo format if specific ones aren't listed for MSA
      title: "Trusted by Industry Leaders for Quality Training", // Relevant title
      image: "/assets/images/training_client.jpeg",
       image2: "/assets/images/training_new.png",
      // Standard client logo image placeholder unless a specific one is on the page
      logos: [
        // Assuming a standard client logo carousel/section might exist
        // Add individual logo objects here if present on the page, e.g.:
        // { "name": "Client A", "image": "/assets/images/clients/client-a.png" },
    ...
    form: {
      ...
      title: "Register Your Interest / Request a Quote",
      description:
        "Fill out the form below to learn more about our Measurement System Analysis (MSA) training, request a customized quote for your team, or inquire about upcoming public batches.",
      buttonTitle: "Submit Request",
    },
  ...
  "design-fmea": {
    ...
    clients: {
      ...
      image: "/assets/images/training_client.jpeg", // Standard client logo image
       image2: "/assets/images/training_new.png",
    },
  ...
  "process-failure-mode-effect-analysis-pfmea": {
    // New entry for PFMEA Training
    title: "Process FMEA (PFMEA) Training", // Matches format
    image: "/herosection-image/PROCESS FMEA (PFMEA) TRAINING.png", // Matches format
    bannerTitle: "PROCESS FMEA (PFMEA) TRAINING", // Matches format
    bannerSubtitle:
      "Analyzing and Mitigating Manufacturing & Assembly Process Risks", // Derived from content
    bannerDescription:
    ...
    whyChoose: {
      ...
      content:
        "Tetrahedron's PFMEA training is delivered by seasoned professionals with extensive hands-on experience in process improvement and quality management across various manufacturing sectors. We emphasize the practical application of the AIAG & VDA 7-Step FMEA process through interactive exercises, relevant case studies, and clear explanations. Our goal is to empower participants to effectively identify process risks and develop robust control plans.",
      subTitle: "Ready to optimize your manufacturing processes?", // Training specific CTA
      subText:
        "Enroll in our PFMEA training to proactively manage process risks.",
    },
    // 'industries' key not applicable.
  ...
  "statistical-process-control": {
    ...
    bannerSubtitle:
      "Monitoring Processes, Reducing Variation, Improving Quality", // Derived from content
    bannerDescription:
    ...
    whyChoose: {
      ...
      content:
        "Tetrahedron's SPC training is designed and delivered by experts with deep statistical knowledge and practical manufacturing experience. We focus on making statistical concepts accessible and applicable, using real-world examples, hands-on exercises (including software tools if applicable), and case studies. Our training ensures participants can confidently select appropriate control charts, interpret process data, and use SPC to drive meaningful process improvements.",
  ...
  "geometric-dimensioning-and-tolerancing": {
    // New entry for GD&T Training
    title: "Geometric Dimensioning and Tolerancing (GD&T) Training", // Matches format
    image: "/herosection-image/geometric-dimensioning-and-tolerancing-gdt-training.png",
    heroBackgroundImage: "/herosection-image/geometric-dimensioning-and-tolerancing-gdt-training.png",
    ...
    keyConcepts: {
      ...
      description:
        "Our training covers the fundamental rules, symbols, and concepts of GD&T based on the ASME Y14.5 standard, including datums, feature control frames, geometric characteristics (Form, Orientation, Location, Profile, Runout), material condition modifiers (MMC, LMC, RFS), and practical application examples.",
    },
    courseContent: {
      title: "GD&T Training Course Outline (Based on ASME Y14.5)",
      // No separate diagram image, using Key Concepts image above.
      modules: [
        // List of modules/topics from page (expanded based on standard GD&T curriculum)
  ...
  //---6
  "advanced-gd-and-t-training": {
    // New entry for Advanced GD&T Training
    title: "Advanced Geometric Dimensioning and Tolerancing (GD&T) Training", // Matches format
    image: "/herosection-image/advanced-gdt-geometric-tolerancing-training.png",
    heroBackgroundImage: "/herosection-image/advanced-gdt-geometric-tolerancing-training.png",
    bannerTitle:
      "ADVANCED GEOMETRIC DIMENSIONING & TOLERANCING (GD&T) TRAINING", // Matches format
    ...
    targetAudience: {
      ...
      prerequisite:
        "Prerequisite: Solid understanding of fundamental GD&T principles (equivalent to a basic GD&T course based on ASME Y14.5).",
      list: [
        // List format from page
    ...
    courseContent: {
      ...
      modules: [
        // List of modules/topics from page (focused on advanced topics)
  ...
  "inventory-management": {
    // New entry for Inventory Management Training
    title: "Inventory Management Training", // Matches format
    image: "/herosection-image/inventory-management-warehouse-training.png",
    heroBackgroundImage: "/herosection-image/inventory-management-warehouse-training.png",
    ...
    keyConcepts: {
      // New Key for Concepts
      title: "Key Inventory Management Concepts Covered",
      image: "/assets/images/resources/main-slider-two-img-1-2.jpg", // Concepts image
      description:
        "Our training covers fundamental and advanced inventory management principles, strategies, and techniques critical for optimizing stock levels and improving supply chain performance.", // Optional description
    },
    courseContent: {
      title: "Inventory Management Training Course Outline",
      // No separate diagram image, using Key Concepts image above.
      modules: [
        // List of modules/topics from page (structured logically)
  ...
  "production-part-approval-process": {
    // New entry for PPAP Training
    title: "Production Part Approval Process (PPAP) Training", // Matches format
    image: "/herosection-image/production-part-approval-process-ppap-training.png",
    heroBackgroundImage: "/herosection-image/production-part-approval-process-ppap-training.png",
    bannerTitle: "PRODUCTION PART APPROVAL PROCESS (PPAP) TRAINING", // Matches format
    bannerSubtitle:
      "Ensuring Supplier Parts Meet Requirements Before Production", // Derived from content
    bannerDescription:
    ...
    ppapElements: {
      ...
      description:
        "The training covers the purpose and requirements for the 18 potential PPAP elements as defined by AIAG, including Design Records, FMEAs, Control Plans, MSA studies, Dimensional Results, Material Certifications, Appearance Approval Reports, and more.",
    },
    courseContent: {
  ...
  "industry-4-0-courses": {
    // New entry for Industry 4.0 Training
    ...
    pillars: [
      ...
      {
        title: "Core Technologies & Concepts of Industry 4.0",
        isSectionTitle: true,
      }, // Flag to render as title
      // Image related to the pillars/concepts
      { image: "/assets/images/resources/f.jpg", isImage: true }, // Flag to render image
      {
        title: "Internet of Things (IoT) / IIoT",
        content:
          "Connecting machines, sensors, and devices to collect and exchange data.",
      },
      {
        title: "Big Data & Analytics",
        content:
          "Analyzing vast amounts of data to optimize processes, predict failures, and improve decision-making.",
      },
      {
        title: "Cloud Computing",
        content:
          "Providing scalable computing resources and platforms for data storage, processing, and application hosting.",
      },
      {
        title: "Artificial Intelligence (AI) & Machine Learning (ML)",
        content:
          "Enabling systems to learn, adapt, make decisions, and automate complex tasks.",
      },
      {
      ...
      },
      {
        ...
        content:
          "Advanced robots (including collaborative robots) automating tasks.", // Added detail
      },
      {
      ...
      },
      {
        title: "Digital Twin",
        content:
          "Virtual replicas of physical assets or processes for simulation and analysis.", // Added detail
      },
      {
        title: "Augmented Reality (AR) / Virtual Reality (VR)",
        content:
          "Enhancing human interaction with digital information and simulated environments.", // Added detail
      },
    ],
    features: [
      // Matches format {icon, title, desc} - Using "Benefits" as features
    ...
    courseContent: {
      ...
      modules: [
        // List of modules/topics from page (structured overview)
  ...
  "industry-5-0": {
    ...
    bannerSubtitle:
      "The Next Industrial Revolution: Mass Personalization & Human-Centric Manufacturing",
    bannerDescription:
  ...
  //--11
  "virtual-reality": {
    // New entry for Virtual Reality Courses
    title: "Virtual Reality Courses", // Matches format
    image: "/herosection-image/virtual-reality-vr-industrial-training.png",
    heroBackgroundImage: "/herosection-image/virtual-reality-vr-industrial-training.png",
    ...
    features: [
      // Using "Benefits of Attending" as features
      {
    ...
    modules: {
      // Workshop Modules / Training Outline
    ...
    brochure: {
      ...
      content:
        "Refer to the complete list of 350+ Training modules or contact us for a detailed brochure.",
    },
    clients: {
  ...
  "design-of-experiment": {
    ...
    image: "/herosection-image/design-of-experiment-doe-training.png",
    heroBackgroundImage: "/herosection-image/design-of-experiment-doe-training.png",
  ...
  "electric-vehicle": {
    ...
    bannerSubtitle:
      "Learn the Fundamentals of Electric Vehicles and Drive the Future of Transportation",
    bannerDescription:
  ...
  "design-for-quality-training": {
    ...
    whyChoose: {
      ...
      content:
        "Tetrahedron's DFQ training is led by experienced professionals who blend theory with hands-on exercises and real-world case studies. Our approach ensures participants not only understand the importance of quality in design but also gain practical skills in applying DFQ tools and techniques to reduce costs, improve manufacturability, and enhance customer satisfaction.",
      subTitle: "Ready to design products that stand out for quality?",
      subText:
        "Join our DFQ training to master the art and science of quality-driven product and process design.",
    },
    courseObjective: {
      title: "Course Objective",
      points: [
  ...
  "oee-calculation-and-improvement-action": {
    ...
    image: "/herosection-image/oee-calculation-manufacturing-improvement-training.png",
    heroBackgroundImage: "/herosection-image/oee-calculation-manufacturing-improvement-training.png",
    bannerTitle: "OEE CALCULATION & IMPROVEMENT ACTION TRAINING",
    bannerSubtitle:
      "Learn How to Implement OEE Calculation and Optimize Manufacturing Efficiency",
    bannerDescription:
  ...
  "total-productive-maintenance-course-tpm": {
    ...
    bannerSubtitle:
      "Enhance Efficiency and Productivity with Total Productive Maintenance",
    bannerDescription:
  ...
  "ul-508a-training": {
    ...
    image: "/herosection-image/ul-508a-industrial-control-panel-training.png",
    heroBackgroundImage: "/herosection-image/ul-508a-industrial-control-panel-training.png",
    heroLayout: "split", // Enable split layout with form
    ...
    whyChoose: {
      ...
      content:
        "Our training is led by industry experts with deep experience in UL 508A compliance and industrial control panel design. We provide practical, hands-on guidance to help you understand the standard, avoid common pitfalls, and ensure your panels are built to the highest safety standards. Stay ahead of regulatory changes and gain the knowledge needed to maintain UL certifications and deliver products that meet global safety expectations.",
      subTitle: "Ready to ensure your panels meet UL 508A standards?",
      subText:
        "Join our UL 508A training and build panels with confidence and compliance.",
    },
    courseObjective: {
      title: "Course Objective",
      points: [
  ...
  "cost-reduction-strategies": {
    // New entry for Cost Reduction Training
    title: "Cost Reduction Strategies Training", // Matches format
    image: "/herosection-image/CORPORATE TRAINING PROGRAMS.png", // Matches format
    bannerTitle: "COST REDUCTION STRATEGIES TRAINING", // Matches format
    bannerSubtitle:
      "Identifying Opportunities, Implementing Savings, Driving Profitability", // Derived from content
    bannerDescription:
    ...
    keyStrategies: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      description:
        "The training explores various methodologies and focus areas for achieving significant cost savings within an organization.", // Optional description
    },
    courseContent: {
  ...
  //---2
  "7-new-qctools": {
    // New entry for 7 New QC Tools Training
    title: "7 New QC Tools Training", // Matches format
    image: "/herosection-image/7 NEW QC TOOLS TRAINING.png", // Matches format
    ...
    keyTools: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      description:
        "This training provides practical knowledge and application skills for each of the seven management and planning tools.", // Optional description
    ...
    courseContent: {
      ...
      modules: [
        // List of modules/topics from page (structured by tool)
  ...
  //--3
  "line-balancing": {
    // New entry for Line Balancing Training
    title: "Line Balancing (LB) Training", // Matches format
    image: "/herosection-image/LINE BALANCING (LB) TRAINING.png", // Matches format
    bannerTitle: "LINE BALANCING (LB) TRAINING", // Matches format
    bannerSubtitle:
      "Optimizing Workflow, Eliminating Bottlenecks, Maximizing Throughput", // Derived from content
    bannerDescription:
    ...
    whyChoose: {
      ...
      subText:
        "Enroll in our Line Balancing training to optimize your assembly lines.",
    },
    // 'industries' key not applicable.
    ...
    keyTechniques: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      description:
        "The training covers essential methodologies and metrics used to analyze and optimize workload distribution across workstations in a production line.", // Optional description
    },
    courseContent: {
  ...
  //--4
  "root-cause-analysis": {
    // New entry for Root Cause Analysis Training
    title: "Root Cause Analysis (RCA) Training", // Matches format
    image: "/herosection-image/root-cause-analysis-rca-training.png",
    heroBackgroundImage: "/herosection-image/root-cause-analysis-rca-training.png",
    ...
    keyTechniques: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      description:
        "The training introduces a variety of structured methods for systematically identifying the underlying causes of problems.", // Optional description
    },
    courseContent: {
  ...
  "simple-low-cost-automation": {
    // New entry for Low Cost Automation Training
    ...
    keyConcepts: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      description:
        "The training explores fundamental mechanical principles and common 'Karakuri' mechanisms used to create simple, effective automation.", // Optional description
    },
    courseContent: {
  ...
  "5s-training-program": {
    ...
    pillars: [
      // Title for the section
      {
        title: "The 5 Pillars of Workplace Organization",
        isSectionTitle: true,
      }, // Flag to render as title
      // Image related to the pillars/concepts
      { image: "/assets/images/resources/f.jpg", isImage: true }, // Flag to render image
      {
        title: "1. Seiri (Sort)",
        content:
          "Identify and remove unnecessary items from the workplace. 'When in doubt, throw it out' (or red-tag it).",
      },
      {
        title: "2. Seiton (Set in Order)",
        content:
          "Arrange necessary items logically so they are easy to find, use, and return. 'A place for everything, and everything in its place'.",
      },
      {
        title: "3. Seiso (Shine)",
        content:
          "Clean the work area thoroughly. Cleaning often doubles as inspection, revealing potential issues.",
      },
      {
        title: "4. Seiketsu (Standardize)",
        content:
          "Establish standards and procedures to maintain the first three S's consistently. Make standards visual.",
      },
      {
        title: "5. Shitsuke (Sustain)",
        content:
          "Develop the discipline to maintain the standards through regular audits, communication, and continuous improvement.",
      },
    ],
    features: [
      // Matches format {icon, title, desc} - Using "Benefits" as features
  ...
  "training-performance-management": {
    // New entry for Performance Management Training
    ...
    keyFocusAreas: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      items: [
        // List format for key areas
        {
          icon: "Goal",
          title: "Goal Setting & Expectation Management (SMART Goals)",
        },
        { icon: "MessageSquare", title: "Ongoing Feedback & Coaching" },
        {
          icon: "ClipboardList",
          title: "Performance Appraisal & Review Techniques",
        },
        ...
        { icon: "FileWarning", title: "Managing Underperformance" },
        {
          icon: "FileCog",
          title:
            "Developing & Implementing Performance Improvement Plans (PIPs)",
        },
  ...
  "training-performance-management": {
    // Entry for Performance Management Training
    title: "Performance Management and Improvement Plan Training", // Matches format
    image: "/assets/images/backgrounds/page-header-bg1.jpg", // Matches format
    bannerTitle: "PERFORMANCE MANAGEMENT & IMPROVEMENT PLAN TRAINING", // Matches format
    bannerSubtitle: "Driving Individual and Organizational Success", // Derived from content
  ...
  "total-quality-management-tqm": {
    ...
    pillars: [
      ...
      { image: "/assets/images/resources/f.jpg", isImage: true }, // Flag to render image
      {
        title: "Customer Focus",
        content:
          "Understanding and exceeding customer needs and expectations (internal and external).",
      },
      {
        title: "Total Employee Involvement / Empowerment",
        content:
          "Engaging all employees in problem-solving and continuous improvement efforts.",
      },
      {
        title: "Process-Centered Thinking",
        content:
          "Viewing work as a series of interconnected processes that can be continuously improved.",
      },
      {
        title: "Integrated System",
        content:
          "Understanding how different functions and processes work together towards common quality goals.",
      },
      {
        title: "Strategic & Systematic Approach",
        content:
          "Integrating quality as a strategic element in planning and decision-making.",
      },
      {
        title: "Continual Improvement (Kaizen)",
        content:
          "Constantly seeking ways to improve processes, products, and services.",
      },
      {
        title: "Fact-Based Decision Making",
        content:
          "Using data and analysis to guide decisions related to quality.",
      },
      {
        title: "Effective Communication",
        content:
          "Open and clear communication at all levels regarding quality goals and performance.",
      },
  ...
  "cost-reduction-by-lean-manufacturing": {
    // New entry for Cost Reduction by Lean Training
    ...
    keyLeanTools: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      items: [
        // List format for key tools/concepts
        { icon: "Trash2", title: "Identifying the 7+1 Wastes (Muda)" },
        {
          icon: "Map",
          title: "Value Stream Mapping (VSM) for Waste Visualization",
        },
  ...
  "why-why-analysis-fish-born-5-why-training": {
    // New entry for 5 Why & Fishbone Training
    ...
    whyChoose: {
      ...
      subText:
        "Learn the essential 5 Why and Fishbone techniques with our focused training.",
    },
    // 'industries' key not applicable.
    // 'pillars' key not directly applicable, using key techniques section.
    ...
    keyTechniquesCovered: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      description:
        "Focusing on the practical application of two foundational root cause analysis tools.", // Optional description
    },
    courseContent: {
  ...
  "kaizen-training-program": {
    // New entry for Kaizen Training
    title: "Kaizen Training Program", // Matches format
    image: "/herosection-image/kaizen-continuous-improvement-training-program.png",
    heroBackgroundImage: "/herosection-image/kaizen-continuous-improvement-training-program.png",
    bannerTitle: "KAIZEN TRAINING PROGRAM", // Matches format
    bannerSubtitle:
      "Empowering Continuous Improvement Through Small, Incremental Changes", // Derived from content
    bannerDescription:
    ...
    keyConcepts: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      items: [
        // List format for key concepts/principles
        ...
        {
          icon: "DollarSign",
          title: "Low-Cost / No-Cost Solutions Prioritized",
        },
  ...
  "value-engineering-value-analysis": {
    // New entry for Value Engineering & Value Analysis Training
    ...
    whyChoose: {
      title:
        "Why Choose Tetrahedron for Value Engineering & Value Analysis Training?",
      content:
      ...
      subText:
        "Master the art and science of Value Engineering & Value Analysis with our comprehensive training.",
    },
    // Target Audience
    targetAudience: [
      "Project Managers",
  ...
  "cost-reduction-by-lean-manufacturing": {
    ...
    bannerSubtitle:
      "Learn How to Implement Cost Reduction Strategies in Manufacturing",
    bannerDescription:
    ...
    whyChoose: {
      ...
      subTitle: "Ready to embark on this exciting learning experience?",
      subText:
        "Join our workshop and unlock your potential to drive efficiency and savings.",
    },
    whoShouldAttend: {
      title: "Who Should Attend?",
      points: [
  ...
  "esg-certification-training": {
    // New entry for ESG Training
    title: "ESG (Environmental, Social, Governance) Training", // Matches format
    image: "/herosection-image/ESG (ENVIRONMENTAL, SOCIAL, GOVERNANCE) TRAINING.png", // Matches format
    bannerTitle: "ESG (ENVIRONMENTAL, SOCIAL, GOVERNANCE) TRAINING", // Matches format
    bannerSubtitle:
      "Integrating Sustainability into Business Strategy and Operations", // Derived from content
    bannerDescription:
    ...
    whyChoose: {
      ...
      content:
        "Tetrahedron's ESG training provides clarity on this rapidly evolving landscape. Our instructors explain complex ESG concepts, frameworks (like GRI, SASB, TCFD), and regulatory trends in an accessible manner. We focus on the practical implications for businesses, helping participants understand how to identify relevant ESG factors, measure performance, develop strategies, and communicate effectively with stakeholders. Our training is designed for professionals across various functions seeking to build ESG competency.",
      subTitle: "Ready to navigate the world of ESG?", // Training specific CTA
      subText:
        "Understand the fundamentals and strategic importance of ESG with our training.",
    },
    // 'industries' key not applicable.
    ...
    keyFocusAreas: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      items: [
        // List format for key areas with icons
        {
          icon: "Leaf",
          title: "Environmental (E)",
          description:
            "Climate change, carbon emissions, energy efficiency, water usage, waste management, biodiversity, pollution prevention.",
        },
        {
          icon: "Users",
          title: "Social (S)",
          description:
            "Human rights, labor standards, diversity & inclusion, employee health & safety, community relations, data privacy, product safety.",
        },
        {
          icon: "Shield",
          title: "Governance (G)",
          description:
            "Board structure & independence, executive compensation, shareholder rights, business ethics, risk management, transparency, anti-corruption.",
        },
  ...
  "daily-work-management": {
    // New entry for Daily Work Management Training
    title: "Daily Work Management (DWM) Training", // Matches format
    image: "/herosection-image/DAILY WORK MANAGEMENT (DWM) TRAINING.png", // Matches format
    bannerTitle: "DAILY WORK MANAGEMENT (DWM) TRAINING", // Matches format
    bannerSubtitle:
      "Establishing Stability, Control, and Improvement in Daily Operations", // Derived from content
    bannerDescription:
    ...
    keyPrinciples: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      items: [
        // List format for key principles/elements with icons
        ...
        {
          icon: "CalendarClock",
          title: "Short Interval Control & Tiered Meetings",
        }, // Combining concepts
        {
          icon: "Search",
          title: "Rapid Problem Solving (e.g., using RCA tools)",
        },
  ...
  //--3
  "design-thinking": {
    // New entry for Design Thinking Training
    title: "Design Thinking Training", // Matches format
    image: "/herosection-image/DESIGN THINKING TRAINING.png", // Matches format
    bannerTitle: "DESIGN THINKING TRAINING", // Matches format
    bannerSubtitle:
      "A Human-Centered Approach to Innovation and Problem Solving", // Derived from content
    bannerDescription:
    ...
    designThinkingPhases: {
      ...
      items: [
        // List format for the phases with icons
        {
          icon: "Heart",
          title: "1. Empathize",
          description:
            "Understand the user's needs, experiences, and motivations through observation, interaction, and immersion.",
        },
        {
          icon: "Target",
          title: "2. Define",
          description:
            "Clearly articulate the core problem or need identified during the empathize phase based on user insights.",
        },
        {
          icon: "Lightbulb",
          title: "3. Ideate",
        ...
        },
        {
          ...
          title: "4. Prototype",
          description:
            "Build inexpensive, scaled-down versions of the potential solutions to explore and test.",
        },
        {
          icon: "CheckSquare",
          title: "5. Test",
          description:
            "Gather user feedback on the prototypes to refine solutions and gain a deeper understanding of the user.",
        },
      ],
    },
    ...
    courseContent: {
      ...
      modules: [
        // List of modules/topics from page (structured logically by phase)
  ...
  "finance-for-non-finance-manager": {
    // New entry for Finance for Non-Finance Training
    ...
    bannerSubtitle:
      "Understanding Financial Concepts to Make Better Business Decisions", // Derived from content
    bannerDescription:
    ...
    whyChoose: {
      ...
      content:
        "Tetrahedron's Finance for Non-Finance training makes finance accessible and relevant. Our experienced instructors use clear explanations, practical examples, and interactive exercises to build financial acumen. We focus on the specific needs of non-finance managers, enabling them to confidently interpret financial data, participate in budgeting processes, and understand the financial implications of their operational decisions.",
      subTitle: "Ready to enhance your financial literacy?", // Training specific CTA
      subText:
        "Gain the essential financial skills needed for effective management.",
    },
    // 'industries' key not applicable.
    // 'pillars' key not directly applicable, using key concepts section.
    keyConcepts: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      description:
        "Equipping non-finance professionals with the ability to understand and utilize core financial information and tools for better business management.", // Optional description
    },
  ...
  "theory-of-inventive-problem-solving": {
    ...
    whyChoose: {
      ...
      content:
        "Tetrahedron's TRIZ training demystifies this powerful methodology, making its concepts and tools accessible and applicable. Our instructors guide participants through the TRIZ framework, focusing on practical application with exercises and case studies relevant to technical and engineering challenges. We aim to equip participants with a systematic approach to innovation and inventive problem solving.",
      subTitle: "Ready to unlock systematic innovation?", // Training specific CTA
      subText:
        "Learn the powerful TRIZ methodology for inventive problem solving.",
    },
    // 'industries' key not applicable.
    ...
    keyConceptsTools: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      items: [
        // List format for key concepts/tools with icons
  ...
  //--6
  "balance-score-card": {
    // New entry for Balanced Scorecard Training
    ...
    bscPerspectives: {
      ...
      items: [
        // List format for the perspectives with icons
        {
          icon: "DollarSign",
          title: "Financial Perspective",
          description:
            "Focuses on financial performance, profitability, growth, and shareholder value. (e.g., Revenue Growth, ROI, Cost Reduction)",
        },
        {
          icon: "Users",
          title: "Customer Perspective",
          description:
            "Focuses on customer satisfaction, retention, market share, and value proposition. (e.g., Customer Satisfaction Score, Market Share, Customer Loyalty)",
        },
        {
          icon: "Settings",
          title: "Internal Business Process Perspective",
          description:
            "Focuses on the efficiency and effectiveness of key internal operations. (e.g., Process Cycle Time, Quality Rates, Innovation Rate)",
        },
        {
          icon: "Brain",
          title: "Learning & Growth Perspective",
          description:
            "Focuses on the organization's ability to innovate, improve, and learn – the foundation for future success. (e.g., Employee Skills, Information Systems Capability, Organizational Culture)",
        },
      ],
    },
  ...
  //--7
  "competency-mapping": {
    // New entry for Competency Mapping Training
    title: "Competency Mapping Training", // Matches format
    image: "/assets/images/backgrounds/page-header-bg1.jpg", // Matches format
    bannerTitle: "COMPETENCY MAPPING TRAINING", // Matches format
    bannerSubtitle:
      "Identifying and Developing Skills for Organizational Success", // Derived from content
    bannerDescription:
    ...
    processSteps: {
      ...
      image: "/assets/images/resources/f.jpg", // Process image
      steps: [
        // List format for the process steps with icons
        {
          icon: "Briefcase",
          title: "1. Identify Key Roles & Business Objectives",
          description:
            "Understanding strategic goals and identifying critical roles needed to achieve them.",
        },
        {
          icon: "ListChecks",
          title: "2. Define Core & Role-Specific Competencies",
          description:
            "Identifying essential skills, knowledge, and behaviors (e.g., technical, behavioral, leadership).",
        },
        {
          icon: "Layers",
          title: "3. Map Competency Proficiency Levels",
          description:
            "Defining different levels of expertise or performance for each competency (e.g., Basic, Intermediate, Advanced).",
        },
        {
          icon: "UserSearch",
          title: "4. Assess Employee Competencies",
          description:
            "Using methods like self-assessment, manager assessment, 360-degree feedback, assessment centers.",
        },
        {
          icon: "GitPullRequest",
          title: "5. Analyze Competency Gaps",
          description:
            "Comparing required competency levels with current employee proficiency to identify gaps.",
        },
        {
          icon: "TrendingUp",
          title: "6. Develop & Implement Action Plans",
          description:
            "Using gap analysis for training, development, recruitment, succession planning, etc.",
        },
      ],
    },
  ...
  "productivity-focus-skill-mapping": {
    // New entry for Productivity Focus Skill Mapping
    ...
    whyChoose: {
      ...
      content:
        "Tetrahedron brings its expertise in operational excellence and workforce development to this specialized training. We guide participants on how to link skill assessment directly to productivity metrics and operational goals. Our practical approach involves analyzing real or simulated tasks, developing skill matrices, and designing targeted training interventions (potentially linking to Dojo concepts) to demonstrably improve efficiency and output.",
    ...
    processSteps: {
      ...
      steps: [
        ...
        {
          icon: "ListChecks",
          title: "1. Identify Critical Processes/Tasks",
          description:
            "Focusing on processes directly impacting productivity, quality, or cost.",
        },
        {
          icon: "Wrench",
          title: "2. Define Required Skills & Proficiency Levels",
          description:
            "Breaking down tasks into specific skills needed for target efficiency (e.g., speed, accuracy).",
        },
        {
          icon: "UserSearch",
          title: "3. Assess Current Operator Skill Levels",
          description:
            "Evaluating proficiency against defined levels using observation, testing, or supervisor input.",
        },
        {
          icon: "Layers3",
          title: "4. Develop Skill Matrix",
          description:
            "Visually representing required vs. actual skill levels for individuals and teams.",
        },
        {
          icon: "GitPullRequest",
          title: "5. Analyze Skill Gaps Impacting Productivity",
          description:
            "Identifying specific skill deficiencies that create bottlenecks or reduce output.",
        },
        {
          icon: "GraduationCap",
          title: "6. Create Targeted Training & Development Plans",
          description:
            "Designing interventions (e.g., On-the-Job Training, Dojo modules) to close critical gaps.",
        },
        {
          icon: "Repeat",
          title: "7. Monitor Progress & Update Matrix",
          description:
            "Tracking skill development and its impact on productivity metrics.",
        },
      ],
    },
  ...
  "world-class-manufacturing": {
    // New entry for World Class Manufacturing Training
    ...
    bannerSubtitle:
      "Integrating Best Practices for Global Manufacturing Excellence", // Derived from content
    bannerDescription:
    ...
    wcmPillars: {
      ...
      description:
        "WCM is typically structured around Technical Pillars focused on specific operational areas and supported by Managerial Pillars driving the culture and system.", // Explanatory text
      // Note: The exact pillars can vary slightly depending on the specific WCM model (e.g., Fiat/Chrysler). Listing common ones.
      technicalPillars: [
        // Example Technical Pillars
        { icon: "ShieldCheck", title: "Safety" },
        { icon: "DollarSign", title: "Cost Deployment" },
        { icon: "Zap", title: "Focused Improvement (Kaizen)" },
        {
          icon: "UserCog",
          title: "Autonomous Activities (Maintenance, Workplace Org)",
        },
  ...
  //--2
  "art-of-delegation-training": {
    // New entry for Art of Delegation Training
    title: "Art of Delegation Training", // Matches format
    image: "/herosection-image/ART OF DELEGATION TRAINING.png", // Matches format
    bannerTitle: "ART OF DELEGATION TRAINING", // Matches format
    bannerSubtitle:
      "Empowering Teams, Maximizing Productivity, Developing Talent", // Derived from content
    bannerDescription:
    ...
    keyPrinciples: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      items: [
        // List format for key principles with icons
        { icon: "ListChecks", title: "Clarity of Task & Expected Outcome" },
        {
          icon: "UserCheck",
          title: "Matching Task to Skill & Development Needs",
        },
        ...
        {
          icon: "MessagesSquare",
          title: "Establishing Clear Communication Channels",
        }, // Using MessagesSquare for communication
        { icon: "ThumbsUp", title: "Providing Constructive Feedback" }, // Using ThumbsUp for feedback
        {
          icon: "Undo2",
          title: "Maintaining Accountability (Without Micromanaging)",
        }, // Using Undo2 for accountability/follow-up
      ],
    },
  ...
  //--3
  "planning-and-prioritization-skill": {
    // New entry for Planning & Prioritization Training
    title: "Planning and Prioritization Skills Training", // Matches format
    image: "/herosection-image/PLANNING AND PRIORITIZATION SKILLS TRAINING.png", // Matches format
    ...
    whyChoose: {
      ...
      subText:
        "Learn essential Planning and Prioritization skills to regain control.",
    },
    // 'industries' key not applicable.
    ...
    keyTechniques: {
      ...
      image: "/assets/images/resources/f.jpg", // Concepts image
      items: [
        // List format for key techniques with icons
        ...
        {
          icon: "Layers",
          title: "Prioritization Matrices (Eisenhower Urgent/Important)",
        },
        { icon: "Filter", title: "ABC Method / MoSCoW Method" }, // Added other common methods
        {
          icon: "CalendarDays",
          title: "Effective Use of Calendars & Planners",
        },
  ...
  //--4
  "team-time-and-task-management": {
    // New entry for Team Time & Task Mgmt Training
    title: "Team Time and Task Management Training", // Matches format
    image: "/herosection-image/TEAM TIME AND TASK MANAGEMENT TRAINING.png", // Matches format
    bannerTitle: "TEAM TIME AND TASK MANAGEMENT TRAINING", // Matches format
    bannerSubtitle:
      "Collaborative Planning, Efficient Execution, Shared Success", // Derived from content
    bannerDescription:
    ...
    whyChoose: {
      ...
      subText:
        "Learn essential strategies for managing time and tasks as a team.",
    },
    // 'industries' key not applicable.
    // Using 'keyFocusAreas' instead of 'pillars'
    keyFocusAreas: {
      ...
      items: [
        ...
        {
          icon: "ListChecks",
          title: "Collaborative Task Planning & Breakdown",
        },
        {
          icon: "Users",
          title: "Effective Task Allocation & Delegation (Team Context)",
        },
        {
          icon: "CalendarClock",
          title: "Coordinated Scheduling & Deadline Management",
        },
        {
          icon: "MessagesSquare",
          title: "Communication & Progress Tracking Tools/Techniques",
        },
        {
          icon: "ShieldAlert",
          title: "Managing Dependencies & Inter-team Coordination",
        },
        {
          icon: "UserCheck",
          title: "Individual Time Management within a Team Setting",
        },
  ...
  "team-development-motivation": {
    // New entry for Team Development & Motivation Training
    title: "Team Development and Motivation Training", // Matches format
    image: "/herosection-image/TEAM DEVELOPMENT AND MOTIVATION TRAINING.png", // Matches format
    ...
    keyFocusAreas: {
      ...
      items: [
        // List format for key areas with icons
        {
          icon: "Users2",
          title:
            "Understanding Team Development Stages (e.g., Tuckman's Model)",
        },
        {
          icon: "MessageSquare",
        ...
        }, // Using HeartHandshake for trust
        { icon: "Goal", title: "Setting Clear Team Goals & Roles" },
        {
          icon: "Flame",
          title:
            "Motivation Theories & Practical Application (e.g., Herzberg, Maslow)",
        }, // Using Flame for motivation
        { icon: "ThumbsUp", title: "Giving Effective Feedback & Recognition" },
        {
          icon: "Combine",
          title: "Constructive Conflict Resolution Techniques",
        }, // Using Combine for conflict resolution
